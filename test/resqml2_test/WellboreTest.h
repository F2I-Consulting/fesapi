...
namespace resqml2_test {
	class WellboreTest : public commontest::AbstractObjectTest {
	public:
		...
		*/
		WellboreTest(const std::string & repoPath);
		...
		*/
		WellboreTest(COMMON_NS::DataObjectRepository* repo, bool init);
	protected:
