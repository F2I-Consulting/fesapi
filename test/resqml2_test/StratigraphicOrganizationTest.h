...
namespace resqml2_test {
	class StratigraphicOrganizationTest : public commontest::AbstractObjectTest {
	public:
		...
		*/
		StratigraphicOrganizationTest(const std::string & repoPath);
		...
		*/
		StratigraphicOrganizationTest(COMMON_NS::DataObjectRepository* repo, bool init);
	protected:
