...
namespace resqml2_test {
	class StratigraphicUnitTest : public commontest::AbstractObjectTest {
	public:
		...
		*/
		StratigraphicUnitTest(const std::string & repoPath);
		...
		*/
		StratigraphicUnitTest(COMMON_NS::DataObjectRepository* repo, bool init);
	protected:
