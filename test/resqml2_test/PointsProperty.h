...
namespace resqml2_test {
	class PointsProperty : public commontest::AbstractObjectTest {
	public:
		...
		*/
		PointsProperty(const std::string & repoPath);
		...
		*/
		PointsProperty(COMMON_NS::DataObjectRepository * repo, bool init);
	protected:
