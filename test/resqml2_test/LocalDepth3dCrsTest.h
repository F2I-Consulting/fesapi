...
namespace resqml2_test {
	class LocalDepth3dCrsTest : public commontest::AbstractObjectTest {
	public:
		...
		*/
		LocalDepth3dCrsTest(const std::string & repoPath);
		...
		*/
		LocalDepth3dCrsTest(COMMON_NS::DataObjectRepository* repo, bool init);
	protected:
