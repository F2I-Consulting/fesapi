...
namespace resqml2_0_1test {
	...
	public:
		...
		*/
		OneTetrahedronUnstructuredGridRepresentationTest(const std::string & repoPath);
		...
		*/
		OneTetrahedronUnstructuredGridRepresentationTest(COMMON_NS::DataObjectRepository * repo, bool init);
	protected:
