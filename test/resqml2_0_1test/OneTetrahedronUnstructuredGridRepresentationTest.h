...
namespace resqml2_0_1test {
	...
	public:
		...
		*/
		OneTetrahedronUnstructuredGridRepresentationTest(const std::string & epcDocPath);
		...
		*/
		OneTetrahedronUnstructuredGridRepresentationTest(COMMON_NS::EpcDocument * epcDoc, bool init);
	protected:
