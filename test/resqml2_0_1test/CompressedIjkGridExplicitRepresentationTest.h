...
namespace resqml2_0_1test {
	class CompressedIjkGridExplicitRepresentationTest : public commontest::AbstractObjectTest {
	public:
		...
		*/
		CompressedIjkGridExplicitRepresentationTest(const std::string & epcDocPath);
		...
		*/
		CompressedIjkGridExplicitRepresentationTest(COMMON_NS::EpcDocument * epcDoc, bool init);
	protected:
