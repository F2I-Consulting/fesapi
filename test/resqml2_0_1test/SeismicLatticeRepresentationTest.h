...
namespace resqml2_0_1test {
	class SeismicLatticeRepresentationTest : public AbstractSurfaceRepresentationTest {
	public:
		...
		*/
		SeismicLatticeRepresentationTest(const std::string & epcDocPath);
		...
		*/
		SeismicLatticeRepresentationTest(COMMON_NS::EpcDocument * epcDocument, bool init);
	protected:
