...
namespace resqml2_0_1test {
	class ContinuousPropertySeriesTest : public ContinuousPropertyTest {
	public:
		...
		*/
		ContinuousPropertySeriesTest(const std::string & epcDocPath);
		...
		*/
		ContinuousPropertySeriesTest(COMMON_NS::EpcDocument * epcDoc, bool init);
	protected:
