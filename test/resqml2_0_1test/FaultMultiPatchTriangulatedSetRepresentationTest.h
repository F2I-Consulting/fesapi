...
namespace resqml2_0_1test {
	class FaultMultiPatchTriangulatedSetRepresentationTest : public TriangulatedSetRepresentationTest {
	public:
		/**
		...
		*/
		FaultMultiPatchTriangulatedSetRepresentationTest(const std::string & epcDocPath);
		...
		*/
		FaultMultiPatchTriangulatedSetRepresentationTest(COMMON_NS::EpcDocument * epcDocument, bool init);
	protected:
