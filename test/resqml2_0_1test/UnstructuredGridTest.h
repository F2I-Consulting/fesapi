...
namespace resqml2_0_1test {
	class UnstructuredGridTest : public commontest::AbstractObjectTest {
	public:
		...
		*/
		UnstructuredGridTest(const std::string & repoPath);
		...
		*/
		UnstructuredGridTest(COMMON_NS::DataObjectRepository * repo, bool init);
	protected:
