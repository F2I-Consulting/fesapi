...
namespace resqml2_0_1test {
	class PolylineSetRepresentation : public AbstractSurfaceRepresentationTest {
	public:
		...
		*/
		PolylineSetRepresentation(const std::string & epcDocPath);
		...
		*/
		PolylineSetRepresentation(COMMON_NS::EpcDocument* epcDoc, bool init);
	protected:
