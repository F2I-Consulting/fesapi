...
namespace resqml2_0_1test {
	class CommentProperty : public commontest::AbstractObjectTest {
	public:
		...
		*/
		CommentProperty(const std::string & repoPath);
		...
		*/
		CommentProperty(COMMON_NS::DataObjectRepository * repo, bool init);
	protected:
