...
namespace resqml2_0_1test {
	class WellboreInterpretationTest : public commontest::AbstractObjectTest {
	public:
		...
		*/
		WellboreInterpretationTest(const std::string & repoPath);
		...
		*/
		WellboreInterpretationTest(COMMON_NS::DataObjectRepository* repo, bool init);
	protected:
