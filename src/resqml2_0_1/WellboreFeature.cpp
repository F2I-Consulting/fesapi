...
{
	return static_cast<resqml20__obj_USCOREWellboreFeature*>(gsoapProxy2_0_1)->WitsmlWellbore != nullptr
		? COMMON_NS::DataObjectReference(static_cast<resqml20__obj_USCOREWellboreFeature*>(gsoapProxy2_0_1)->WitsmlWellbore->WitsmlWellbore)
