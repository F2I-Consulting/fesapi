...
const char* StreamlinesFeature::XML_NS = "resqml20";
...
StreamlinesFeature::StreamlinesFeature(COMMON_NS::DataObjectRepository* repo, const std::string & guid, const std::string & title, uint64_t timeIndex, EML2_NS::TimeSeries* timeSeries)
{
	...
	gsoapProxy2_0_1 = soap_new_resqml20__obj_USCOREStreamlinesFeature(repo->getGsoapContext());
	_resqml20__StreamlinesFeature* sf = static_cast<_resqml20__StreamlinesFeature*>(gsoapProxy2_0_1);
	sf->TimeIndex = soap_new_resqml20__TimeIndex(repo->getGsoapContext());
...
COMMON_NS::DataObjectReference StreamlinesFeature::getTimeSeriesDor() const
{
	...
	return COMMON_NS::DataObjectReference(static_cast<_resqml20__StreamlinesFeature*>(gsoapProxy2_0_1)->TimeIndex->TimeSeries);
}

uint64_t StreamlinesFeature::getTimeIndex() const
{
	return static_cast<_resqml20__StreamlinesFeature*>(gsoapProxy2_0_1)->TimeIndex->Index;
}
