...
{
	/** A local time 3D crs. */
	class LocalTime3dCrs final : public EML2_NS::AbstractLocal3dCrs
	{
	private:
	...
	public:
		...
		DLL_IMPORT_OR_EXPORT bool isATimeCrs() const final { return true; }
		...
		*/
		...
		DLL_IMPORT_OR_EXPORT static constexpr char const* XML_TAG = "LocalTime3dCrs";
