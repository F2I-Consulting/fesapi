...
namespace RESQML2_0_1_NS
{
	...
	public:
		 ...
		 */
		StreamlinesRepresentation(gsoap_resqml2_0_1::_resqml20__StreamlinesRepresentation* fromGsoap) : RESQML2_NS::StreamlinesRepresentation(fromGsoap) {}
		...
		*/
		...
		void setWellboreInformation(uint32_t const* injectorPerLine, uint32_t const* producerPerLine, const std::vector<RESQML2_NS::WellboreTrajectoryRepresentation*> & wellboreTrajectories,
			uint32_t nullValue = (std::numeric_limits<uint32_t>::max)(), EML2_NS::AbstractHdfProxy* hdfProxy = nullptr) final;
		...
		*/
		...
		DLL_IMPORT_OR_EXPORT void setGeometry(
			...
			EML2_NS::AbstractHdfProxy* hdfProxy = nullptr, EML2_NS::AbstractLocal3dCrs* localCrs = nullptr)  final;
