...
namespace RESQML2_0_1_NS
{
	...
	public:
		...
		/**
		 * Gets all the trajectory representations of this wellbore interpretation.
		 *
		 * @returns	A vector of pointers to all the trajectory representations of this wellbore
		 * 			interpretation.
		 */
