...
namespace RESQML2_0_1_NS
{
	...
	*/
	class StratigraphicOccurrenceInterpretation final : public RESQML2_NS::GeologicUnitOccurrenceInterpretation
	{
	public:
		...
		*/
		DLL_IMPORT_OR_EXPORT StratigraphicOccurrenceInterpretation(gsoap_resqml2_0_1::eml20__DataObjectReference* partialObject) : RESQML2_NS::GeologicUnitOccurrenceInterpretation(partialObject) {}
		...
		*/
		StratigraphicOccurrenceInterpretation(gsoap_resqml2_0_1::_resqml20__StratigraphicOccurrenceInterpretation* fromGsoap) : RESQML2_NS::GeologicUnitOccurrenceInterpretation(fromGsoap) {}
