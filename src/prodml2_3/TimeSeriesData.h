...
namespace PRODML2_3_NS
{
	...
	public:
		...
		*/
		DLL_IMPORT_OR_EXPORT void pushBackKeywordValue(gsoap_eml2_3::prodml23__TimeSeriesKeyword keyword, const std::string & value);
		...
		*/
		DLL_IMPORT_OR_EXPORT void pushBackDoubleValue(double value, time_t timestamp, gsoap_eml2_3::prodml23__ValueStatus status);
		...
		*/
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::prodml23__ValueStatus getValueStatus(unsigned int index) const;
		...
		*/
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::prodml23__TimeSeriesKeyword getKeyword(unsigned int index) const;
