...
namespace PRODML2_3_NS
{
	...
	public:
		 ...
		 */
		FrictionTheorySpecification(gsoap_eml2_3::prodml23__FrictionTheory* fromGsoap): CompositionalViscositySpecification(fromGsoap) {}
		...
		DLL_IMPORT_OR_EXPORT unsigned int getPrsvParameterCount() const {
			size_t count = static_cast<gsoap_eml2_3::prodml23__FrictionTheory*>(gsoapProxy)->PrsvParameter.size();
		...
		DLL_IMPORT_OR_EXPORT double getPrsvParameterA1(unsigned int index) const
		{
			...
			return static_cast<gsoap_eml2_3::prodml23__FrictionTheory*>(gsoapProxy)->PrsvParameter[index]->a1;
		}
		...
		DLL_IMPORT_OR_EXPORT double getPrsvParameterA2(unsigned int index) const
		{
			...
			return static_cast<gsoap_eml2_3::prodml23__FrictionTheory*>(gsoapProxy)->PrsvParameter[index]->a2;
		}
		...
		DLL_IMPORT_OR_EXPORT double getPrsvParameterB1(unsigned int index) const
		{
			...
			return static_cast<gsoap_eml2_3::prodml23__FrictionTheory*>(gsoapProxy)->PrsvParameter[index]->b1;
		}
		...
		DLL_IMPORT_OR_EXPORT double getPrsvParameterB2(unsigned int index) const
		{
			...
			return static_cast<gsoap_eml2_3::prodml23__FrictionTheory*>(gsoapProxy)->PrsvParameter[index]->b2;
		}
		...
		DLL_IMPORT_OR_EXPORT double getPrsvParameterC2(unsigned int index) const
		{
			...
			return static_cast<gsoap_eml2_3::prodml23__FrictionTheory*>(gsoapProxy)->PrsvParameter[index]->c2;
		}
		...
		DLL_IMPORT_OR_EXPORT std::string getPrsvParameterFluidComponentReference(unsigned int index) const
		{
			...
			return static_cast<gsoap_eml2_3::prodml23__FrictionTheory*>(gsoapProxy)->PrsvParameter[index]->fluidComponentReference;
		}
