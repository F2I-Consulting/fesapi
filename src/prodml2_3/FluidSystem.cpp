	...
	double gasOilRatio, gsoap_eml2_3::eml23__VolumePerVolumeUom gasOilRatioUom)
{
	...
	gsoapProxy2_3 = soap_new_prodml23__FluidSystem(repo->getGsoapContext());

	initMandatoryMetadata();
	setMetadata(guid, title, "", -1, "", "", -1, "");

	prodml23__FluidSystem* fs = static_cast<prodml23__FluidSystem*>(gsoapProxy2_3);
...
SETTER_OPTIONAL_ATTRIBUTE_IMPL(FluidSystem, ::prodml23__FluidSystem, gsoapProxy2_3, ReservoirLifeCycleState, gsoap_eml2_3::prodml23__ReservoirLifeCycleState, soap_new_prodml23__ReservoirLifeCycleState)
...
double FluidSystem::getSolutionGORValue() const {
	return static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->SolutionGOR->__item;
}

gsoap_eml2_3::eml23__VolumePerVolumeUom FluidSystem::getSolutionGORUom() const
{
	gsoap_eml2_3::eml23__VolumePerVolumeUom result;
	if (gsoap_eml2_3::soap_s2eml23__VolumePerVolumeUom(getGsoapContext(), static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->SolutionGOR->uom.c_str(), &result) == SOAP_OK) {
		return result;
	}
	throw logic_error("Cannot recognize the exotic volume per volume uom : " + static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->SolutionGOR->uom);
}

void FluidSystem::setSaturationPressure(double value, gsoap_eml2_3::eml23__PressureUom pressureUom, gsoap_eml2_3::prodml23__SaturationPointKind saturationPointKind)
{
	prodml23__FluidSystem* fs = static_cast<prodml23__FluidSystem*>(gsoapProxy2_3);
	if (fs->SaturationPressure == nullptr) {
		fs->SaturationPressure = soap_new_prodml23__SaturationPressure(getGsoapContext());
	}
	if (fs->SaturationPressure->PressureMeasureExt == nullptr) {
		fs->SaturationPressure->PressureMeasureExt = soap_new_eml23__PressureMeasureExt(getGsoapContext());
	}
	fs->SaturationPressure->kind = saturationPointKind;
	fs->SaturationPressure->PressureMeasureExt->uom = soap_eml23__PressureUom2s(getGsoapContext(), pressureUom);
	fs->SaturationPressure->PressureMeasureExt->__item = value;
}

bool FluidSystem::hasSaturationPressureValue() const
{
	return static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->SaturationPressure != nullptr;
}
...
double FluidSystem::getSaturationPressureValue() const
{
	...
	return static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->SaturationPressure->PressureMeasureExt->__item;
}
 ...
 gsoap_eml2_3::eml23__PressureUom FluidSystem::getSaturationPressureUom() const
 {
	 ...
	 string uomStr = static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->SaturationPressure->PressureMeasureExt->uom;
	 gsoap_eml2_3::eml23__PressureUom result;
...
gsoap_eml2_3::prodml23__SaturationPointKind FluidSystem::getSaturationPressurePointKind() const
{
	if (!hasSaturationPressureValue()) {
		throw logic_error("There is no saturation pressure value");
	}
	return static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->SaturationPressure->kind;
}
...
{\
	if (static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->componentName == nullptr) {\
		static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->componentName = soap_new_prodml23__##componentName(getGsoapContext());\
		static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->componentName->uid = "0";\
	}\
	static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->componentName->attributeName = constructor(getGsoapContext());\
	*static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->componentName->attributeName = value;\
}
...
{\
	...
	static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->componentName->attributeName = constructor(getGsoapContext());\
	static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->componentName->attributeName->__item = value;\
	static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->componentName->attributeName->uom = uom;\
}
...
void FluidSystem::setRockFluidOrganization(RESQML2_NS::RockFluidOrganizationInterpretation* rockFluidOrg)
{
	...
	if (static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->RockFluidOrganizationInterpretation != nullptr) {
...
COMMON_NS::DataObjectReference FluidSystem::getRockFluidOrganizationDor() const
{
	...
	return COMMON_NS::DataObjectReference(static_cast<prodml23__FluidSystem*>(gsoapProxy2_3)->RockFluidOrganizationInterpretation);
}
