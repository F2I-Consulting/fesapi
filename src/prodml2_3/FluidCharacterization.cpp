	...
	const std::string & title)
{
	...
	gsoapProxy2_3 = soap_new_prodml23__FluidCharacterization(repo->getGsoapContext());
...
SETTER_OPTIONAL_ATTRIBUTE_IMPL(FluidCharacterization, prodml23__FluidCharacterization, gsoapProxy2_3, IntendedUsage, std::string, soap_new_std__string)
SETTER_OPTIONAL_ATTRIBUTE_IMPL(FluidCharacterization, prodml23__FluidCharacterization, gsoapProxy2_3, Remark, std::string, soap_new_std__string)
...
{
	prodml23__FluidCharacterization* fc = static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3);
...
{
	return static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->StandardConditions != nullptr;
}
...
{
	return static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->RockFluidUnitInterpretation;
}
...
void FluidCharacterization::setFluidSystem(FluidSystem* fluidSystem)
{
	...
	if (static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidSystem != nullptr) {
...
{
	return static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidSystem;
}
...
{\
	if (static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog == nullptr || index >= static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->vectorName.size()) {throw std::out_of_range("This index is out of range.");}\
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->vectorName[index]->attributeName = constructor(getGsoapContext());\
	*static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->vectorName[index]->attributeName = value;\
}
...
{\
	if (static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog == nullptr || index >= static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->vectorName.size()) {throw std::out_of_range("This index is out of range.");}\
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->vectorName[index]->attributeName = constructor(getGsoapContext());\
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->vectorName[index]->attributeName->__item = value;\
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->vectorName[index]->attributeName->uom = uom;\
}
...
{
	if (static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog == nullptr) {
		return 0;
	}

	size_t count = static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->FormationWater.size();
...
{
	if (static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog == nullptr) {
		static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog = soap_new_prodml23__FluidComponentCatalog(getGsoapContext());
	}

	prodml23__FormationWater* const result = soap_new_prodml23__FormationWater(getGsoapContext());
	result->uid = uid;
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->FormationWater.push_back(result);
}
...
unsigned int FluidCharacterization::getPureFluidComponentCount() const
{
	...
	size_t count = static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->PureFluidComponent.size();
	if (count > (std::numeric_limits<unsigned int>::max)()) {
		throw out_of_range("There are too much PureFluidComponent");
	}
	return static_cast<unsigned int>(count);
}
void FluidCharacterization::pushBackPureFluidComponent(const std::string & uid, gsoap_eml2_3::prodml23__PureComponentKind kind, bool hydrocarbonFlag)
{
	if (static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog == nullptr) {
		static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog = soap_new_prodml23__FluidComponentCatalog(getGsoapContext());
	}

	prodml23__PureFluidComponent* const result = soap_new_prodml23__PureFluidComponent(getGsoapContext());
	result->uid = uid;
	result->Kind = gsoap_eml2_3::soap_prodml23__PureComponentKind2s(getGsoapContext(), kind);
	result->HydrocarbonFlag = hydrocarbonFlag;
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->PureFluidComponent.push_back(result);
}
...
unsigned int FluidCharacterization::getPlusFluidComponentCount() const
{
	...
	size_t count = static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->PlusFluidComponent.size();
	if (count > (std::numeric_limits<unsigned int>::max)()) {
		throw out_of_range("There are too much PlusFluidComponent");
	}
	return static_cast<unsigned int>(count);
}
void FluidCharacterization::pushBackPlusFluidComponent(const std::string & uid, gsoap_eml2_3::prodml23__PlusComponentKind kind)
{
	if (static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog == nullptr) {
		static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog = soap_new_prodml23__FluidComponentCatalog(getGsoapContext());
	}

	prodml23__PlusFluidComponent* const result = soap_new_prodml23__PlusFluidComponent(getGsoapContext());
	result->uid = uid;
	result->Kind = gsoap_eml2_3::soap_prodml23__PlusComponentKind2s(getGsoapContext(), kind);
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->PlusFluidComponent.push_back(result);
}
...
unsigned int FluidCharacterization::getStockTankOilCount() const
{
	...
	size_t count = static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->StockTankOil.size();
	if (count > (std::numeric_limits<unsigned int>::max)()) {
...
void FluidCharacterization::pushBackStockTankOil(const std::string & uid)
{
	...
	prodml23__StockTankOil* const result = soap_new_prodml23__StockTankOil(getGsoapContext());
	result->uid = uid;
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->StockTankOil.push_back(result);
}
...
unsigned int FluidCharacterization::getNaturalGasCount() const
{
	...
	size_t count = static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->NaturalGas.size();
	if (count > (std::numeric_limits<unsigned int>::max)()) {
...
void FluidCharacterization::pushBackNaturalGas(const std::string & uid)
{
	...
	prodml23__NaturalGas* const result = soap_new_prodml23__NaturalGas(getGsoapContext());
	result->uid = uid;
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->NaturalGas.push_back(result);
}
...
unsigned int FluidCharacterization::getPseudoFluidComponentCount() const
{
	...
	size_t count = static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->PseudoFluidComponent.size();
	if (count > (std::numeric_limits<unsigned int>::max)()) {
		throw out_of_range("There are too much PseudoFluidComponent");
	}
	return static_cast<unsigned int>(count);
}
void FluidCharacterization::pushBackPseudoFluidComponent(const std::string & uid, gsoap_eml2_3::prodml23__PseudoComponentKind kind)
{
	if (static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog == nullptr) {
		static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog = soap_new_prodml23__FluidComponentCatalog(getGsoapContext());
	}

	prodml23__PseudoFluidComponent* const result = soap_new_prodml23__PseudoFluidComponent(getGsoapContext());
	result->uid = uid;
	result->Kind = gsoap_eml2_3::soap_prodml23__PseudoComponentKind2s(getGsoapContext(), kind);
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->PseudoFluidComponent.push_back(result);
}
...
{
	size_t count = static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model.size();
	if (count > (std::numeric_limits<unsigned int>::max)()) {
...
{
	prodml23__FluidCharacterizationModel* const result = soap_new_prodml23__FluidCharacterizationModel(getGsoapContext());
	result->uid = uid.empty() 
		? std::to_string(static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model.size())
		: uid;
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model.push_back(result);
...
{
	if (static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model.size() <= modelIndex) {
	...
	switch (kind) {
		case CompositionalThermal:
			...
			break;
		case SrkEos:
			modelSpecifications[modelIndex] = new CompositionalSpecification(soap_new_prodml23__Srk_USCOREEOS(getGsoapContext()));
			break;
		case PengRobinson76Eos:
			modelSpecifications[modelIndex] = new CompositionalSpecification(soap_new_prodml23__PengRobinson76_USCOREEOS(getGsoapContext()));
			break;
		case PengRobinson78Eos:
			modelSpecifications[modelIndex] = new CompositionalSpecification(soap_new_prodml23__PengRobinson78_USCOREEOS(getGsoapContext()));
			break;
		case LohrenzBrayClarkCorrelation:
			modelSpecifications[modelIndex] = new CompositionalViscositySpecification(soap_new_prodml23__Lohrenz_Bray_ClarkCorrelation(getGsoapContext()));
			break;
		case CSPedersen84:
			modelSpecifications[modelIndex] = new CompositionalViscositySpecification(soap_new_prodml23__CSPedersen84(getGsoapContext()));
			break;
		case CSPedersen87: 
			modelSpecifications[modelIndex] = new CompositionalViscositySpecification(soap_new_prodml23__CSPedersen87(getGsoapContext()));
			break;
		case FrictionTheory:
			modelSpecifications[modelIndex] = new FrictionTheorySpecification(soap_new_prodml23__FrictionTheory(getGsoapContext()));
			break;
		case CorrelationThermal:
			modelSpecifications[modelIndex] = new PvtSpecification(soap_new_prodml23__CorrelationThermalModel(getGsoapContext()));
			break;
		case BergmanSuttonBubblePoint:
			modelSpecifications[modelIndex] = new CorrelationViscosityBubblePointSpecification(soap_new_prodml23__BergmanSutton_BubblePoint(getGsoapContext()));
			break;
		case DeGhettoBubblePoint:
			modelSpecifications[modelIndex] = new CorrelationViscosityBubblePointSpecification(soap_new_prodml23__DeGhetto_BubblePoint(getGsoapContext()));
			break;
		case StandingBubblePoint:
			modelSpecifications[modelIndex] = new CorrelationViscosityBubblePointSpecification(soap_new_prodml23__Standing_BubblePoint(getGsoapContext()));
			break;
		case DindorukChristmanBubblePoint:
			modelSpecifications[modelIndex] = new CorrelationViscosityBubblePointSpecification(soap_new_prodml23__DindorukChristman_BubblePoint(getGsoapContext()));
			break;
		case PetroskyFarshadBubblePoint:
			modelSpecifications[modelIndex] = new CorrelationViscosityBubblePointSpecification(soap_new_prodml23__PetroskyFarshad_BubblePoint(getGsoapContext()));
			break;
		default: throw std::invalid_argument("This kind of specification is not supported yet");
	}
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->ModelSpecification = modelSpecifications[modelIndex]->gsoapProxy;

	return modelSpecifications[modelIndex];
}

SETTER_OPTIONAL_ATTRIBUTE_IN_VECTOR_IMPL(FluidCharacterization, gsoap_eml2_3::prodml23__FluidCharacterization, gsoapProxy2_3, Model, Name, std::string, gsoap_eml2_3::soap_new_std__string)
SETTER_OPTIONAL_ATTRIBUTE_IN_VECTOR_IMPL(FluidCharacterization, gsoap_eml2_3::prodml23__FluidCharacterization, gsoapProxy2_3, Model, Remark, std::string, gsoap_eml2_3::soap_new_std__string)
SETTER_MEASURE_ATTRIBUTE_IN_VECTOR_IMPL(FluidCharacterization, gsoap_eml2_3::prodml23__FluidCharacterization, gsoapProxy2_3, Model, ReferenceTemperature, gsoap_eml2_3::eml23__ThermodynamicTemperatureUom, gsoap_eml2_3::soap_new_eml23__ThermodynamicTemperatureMeasure)
SETTER_MEASURE_ATTRIBUTE_IN_VECTOR_IMPL(FluidCharacterization, gsoap_eml2_3::prodml23__FluidCharacterization, gsoapProxy2_3, Model, ReferenceStockTankTemperature, gsoap_eml2_3::eml23__ThermodynamicTemperatureUom, gsoap_eml2_3::soap_new_eml23__ThermodynamicTemperatureMeasure)
	...
	for (size_t modelIndex = 0; modelIndex < models.size(); ++modelIndex) {
		if (models[modelIndex]->ModelSpecification != nullptr) {
			switch (models[modelIndex]->ModelSpecification->soap_type()) {
				case SOAP_TYPE_gsoap_eml2_3_prodml23__CompositionalThermalModel:
					modelSpecifications.push_back(new CompositionalSpecification(static_cast<prodml23__CompositionalThermalModel*>(models[modelIndex]->ModelSpecification)));
					break;
				case SOAP_TYPE_gsoap_eml2_3_prodml23__Srk_USCOREEOS:
					modelSpecifications.push_back(new CompositionalSpecification(static_cast<prodml23__Srk_USCOREEOS*>(models[modelIndex]->ModelSpecification)));
					break;
				case SOAP_TYPE_gsoap_eml2_3_prodml23__PengRobinson76_USCOREEOS:
					modelSpecifications.push_back(new CompositionalSpecification(static_cast<prodml23__PengRobinson76_USCOREEOS*>(models[modelIndex]->ModelSpecification)));
					break;
				case SOAP_TYPE_gsoap_eml2_3_prodml23__PengRobinson78_USCOREEOS:
					modelSpecifications.push_back(new CompositionalSpecification(static_cast<prodml23__PengRobinson78_USCOREEOS*>(models[modelIndex]->ModelSpecification)));
					break;
				case SOAP_TYPE_gsoap_eml2_3_prodml23__Lohrenz_Bray_ClarkCorrelation:
					modelSpecifications.push_back(new CompositionalViscositySpecification(static_cast<prodml23__Lohrenz_Bray_ClarkCorrelation*>(models[modelIndex]->ModelSpecification)));
					break;
				case SOAP_TYPE_gsoap_eml2_3_prodml23__CSPedersen84:
					modelSpecifications.push_back(new CompositionalViscositySpecification(static_cast<prodml23__CSPedersen84*>(models[modelIndex]->ModelSpecification)));
					break;
				case SOAP_TYPE_gsoap_eml2_3_prodml23__CSPedersen87:
					modelSpecifications.push_back(new CompositionalViscositySpecification(static_cast<prodml23__CSPedersen87*>(models[modelIndex]->ModelSpecification)));
					break;
				case SOAP_TYPE_gsoap_eml2_3_prodml23__FrictionTheory:
					modelSpecifications.push_back(new FrictionTheorySpecification(static_cast<prodml23__FrictionTheory*>(models[modelIndex]->ModelSpecification)));
					break;
				case SOAP_TYPE_gsoap_eml2_3_prodml23__CorrelationThermalModel:
					modelSpecifications.push_back(new PvtSpecification(static_cast<prodml23__CorrelationThermalModel*>(models[modelIndex]->ModelSpecification)));
					break;
				case SOAP_TYPE_gsoap_eml2_3_prodml23__BergmanSutton_BubblePoint:
					modelSpecifications.push_back(new CorrelationViscosityBubblePointSpecification(static_cast<prodml23__BergmanSutton_BubblePoint*>(models[modelIndex]->ModelSpecification)));
					break;
				case SOAP_TYPE_gsoap_eml2_3_prodml23__DeGhetto_BubblePoint:
					modelSpecifications.push_back(new CorrelationViscosityBubblePointSpecification(static_cast<prodml23__DeGhetto_BubblePoint*>(models[modelIndex]->ModelSpecification)));
					break;
				case SOAP_TYPE_gsoap_eml2_3_prodml23__Standing_BubblePoint:
					modelSpecifications.push_back(new CorrelationViscosityBubblePointSpecification(static_cast<prodml23__Standing_BubblePoint*>(models[modelIndex]->ModelSpecification)));
					break;
				case SOAP_TYPE_gsoap_eml2_3_prodml23__DindorukChristman_BubblePoint:
					modelSpecifications.push_back(new CorrelationViscosityBubblePointSpecification(static_cast<prodml23__DindorukChristman_BubblePoint*>(models[modelIndex]->ModelSpecification)));
					break;
				case SOAP_TYPE_gsoap_eml2_3_prodml23__PetroskyFarshad_BubblePoint:
					modelSpecifications.push_back(new CorrelationViscosityBubblePointSpecification(static_cast<prodml23__PetroskyFarshad_BubblePoint*>(models[modelIndex]->ModelSpecification)));
					break;
				default: throw std::invalid_argument("This kind of specification is not supported yet");
			}
		}
...
{
	size_t count = static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->TableFormat.size();
	if (count > (std::numeric_limits<unsigned int>::max)()) {
...
{
	for (const auto& tableFormat : static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->TableFormat) {
...
{
	prodml23__FluidCharacterizationTableFormat* const result = soap_new_prodml23__FluidCharacterizationTableFormat(getGsoapContext());
	result->Delimiter = soap_new_std__string(getGsoapContext());
	result->Delimiter->assign(" ");
	result->uid = uid.empty()
		? std::to_string(static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->TableFormat.size())
		: uid;
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->TableFormat.push_back(result);
}
...
void FluidCharacterization::pushBackTableFormatColumn(unsigned int tableFormatIndex, gsoap_eml2_3::eml23__UnitOfMeasure uom, gsoap_eml2_3::prodml23__OutputFluidProperty fluidProperty)
{
	pushBackTableFormatColumn(tableFormatIndex,
		gsoap_eml2_3::soap_eml23__UnitOfMeasure2s(getGsoapContext(), uom),
		gsoap_eml2_3::soap_prodml23__OutputFluidProperty2s(getGsoapContext(), fluidProperty));
}
...
{
	if (static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->TableFormat.size() <= tableFormatIndex) {
		throw std::out_of_range("The table format index is out of range.");
	}

	prodml23__FluidCharacterizationTableColumn* const result = soap_new_prodml23__FluidCharacterizationTableColumn(getGsoapContext());
	result->uom = uom;
	result->Property = fluidProperty;
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->TableFormat[tableFormatIndex]->TableColumn.push_back(result);
}
...
unsigned int FluidCharacterization::getTableCount(unsigned int modelIndex) const
{
	...
	size_t count = static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationTable.size();
	if (count > (std::numeric_limits<unsigned int>::max)()) {
...
std::string FluidCharacterization::getTableName(unsigned int modelIndex, unsigned int tableIndex) const
{
	...
	if (static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationTable.size() <= tableIndex) {
		throw std::out_of_range("The table index is out of range.");
	}

	return static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationTable[tableIndex]->name;
}
...
std::string FluidCharacterization::getTableFormatUid(unsigned int modelIndex, unsigned int tableIndex) const
{
	...
	return static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationTable[tableIndex]->tableFormat;
}
...
void FluidCharacterization::pushBackTable(unsigned int modelIndex, const std::string & name, const std::string & tableFormatUid, const std::string & uid)
{
	...
	prodml23__FluidCharacterizationTable* const result = soap_new_prodml23__FluidCharacterizationTable(getGsoapContext());
	result->uid = uid.empty()
		? std::to_string(static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationTable.size())
		: uid;

	result->name = name;
	result->tableFormat = tableFormatUid;
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationTable.push_back(result);
}
...
unsigned int FluidCharacterization::getTableRowCount(unsigned int modelIndex, unsigned int tableIndex) const
{
	...
	size_t count = static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationTable[tableIndex]->TableRow.size();
	if (count > (std::numeric_limits<unsigned int>::max)()) {
...
std::string FluidCharacterization::getTableRowContent(unsigned int modelIndex, unsigned int tableIndex, unsigned int rowIndex) const
{
	...
	if (static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationTable[tableIndex]->TableRow.size() <= rowIndex) {
		throw std::out_of_range("The row index is out of range.");
	}

	return static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationTable[tableIndex]->TableRow[rowIndex]->__item;
}
...
void FluidCharacterization::pushBackTableRow(unsigned int modelIndex, unsigned int tableIndex, const std::vector<double> & rowContent)
{
	...
	prodml23__FluidCharacterizationTableRow* const result = soap_new_prodml23__FluidCharacterizationTableRow(getGsoapContext());
	result->row = std::to_string(static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationTable[tableIndex]->TableRow.size());
	...
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationTable[tableIndex]->TableRow.push_back(result);
}
...
void FluidCharacterization::pushBackTableRow(unsigned int modelIndex, unsigned int tableIndex, const std::vector<double> & rowContent, bool isSaturated)
{
	...
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationTable[tableIndex]->TableRow.back()->kind = (gsoap_eml2_3::prodml23__SaturationKind*)soap_malloc(getGsoapContext(), sizeof(gsoap_eml2_3::prodml23__SaturationKind));
	*static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationTable[tableIndex]->TableRow.back()->kind = isSaturated
		? prodml23__SaturationKind::saturated
		: prodml23__SaturationKind::undersaturated;
}

void FluidCharacterization::pushBackParameter(unsigned int modelIndex, double value, gsoap_eml2_3::eml23__UnitOfMeasure uom, gsoap_eml2_3::prodml23__OutputFluidProperty fluidProperty)
{
	if (static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model.size() <= modelIndex) {
		throw std::out_of_range("The model index is out of range.");
	}
	...
	auto* model = static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex];
	if (model->FluidCharacterizationParameterSet == nullptr) {
		model->FluidCharacterizationParameterSet = soap_new_prodml23__FluidCharacterizationParameterSet(getGsoapContext());
	}

	auto* param = soap_new_prodml23__FluidCharacterizationParameter(getGsoapContext());
	param->value = value;
	param->uom = gsoap_eml2_3::soap_eml23__UnitOfMeasure2s(getGsoapContext(), uom);
	param->Property = gsoap_eml2_3::soap_prodml23__OutputFluidProperty2s(getGsoapContext(), fluidProperty);

	model->FluidCharacterizationParameterSet->FluidCharacterizationParameter.push_back(param);
}

void FluidCharacterization::pushBackParameter(unsigned int modelIndex, double value, gsoap_eml2_3::eml23__UnitOfMeasure uom, gsoap_eml2_3::prodml23__OutputFluidProperty fluidProperty, gsoap_eml2_3::prodml23__ThermodynamicPhase phase)
{
	pushBackParameter(modelIndex, value, uom, fluidProperty);
	static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationParameterSet->FluidCharacterizationParameter.back()->Phase = (gsoap_eml2_3::prodml23__ThermodynamicPhase*)soap_malloc(getGsoapContext(), sizeof(gsoap_eml2_3::prodml23__ThermodynamicPhase));
	*static_cast<prodml23__FluidCharacterization*>(gsoapProxy2_3)->Model[modelIndex]->FluidCharacterizationParameterSet->FluidCharacterizationParameter.back()->Phase = phase;
}
