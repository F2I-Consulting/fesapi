...
namespace PRODML2_3_NS
{
	...
	public:
		...
		DLL_IMPORT_OR_EXPORT unsigned int getCoefficientCount() const {
			...
			size_t count = static_cast<gsoap_eml2_3::prodml23__AbstractPvtModel*>(gsoapProxy)->PvtModelParameterSet->Coefficient.size();
		...
		DLL_IMPORT_OR_EXPORT double getCoefficientValue(unsigned int index) const
		{
			...
			return static_cast<gsoap_eml2_3::prodml23__AbstractPvtModel*>(gsoapProxy)->PvtModelParameterSet->Coefficient[index]->__item;
		}
		 ...
		 */
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::prodml23__PvtModelParameterKind getCoefficientKind(unsigned int index) const;
		...
		DLL_IMPORT_OR_EXPORT bool hasCoefficientName(unsigned int index) const
		{
			...
			return static_cast<gsoap_eml2_3::prodml23__AbstractPvtModel*>(gsoapProxy)->PvtModelParameterSet->Coefficient[index]->name != nullptr;
		}
		...
		DLL_IMPORT_OR_EXPORT std::string getCoefficientName(unsigned int index) const
		{
			...
			return *static_cast<gsoap_eml2_3::prodml23__AbstractPvtModel*>(gsoapProxy)->PvtModelParameterSet->Coefficient[index]->name;
		}
		 ...
		 */
		DLL_IMPORT_OR_EXPORT void pushBackCoefficient(double value, gsoap_eml2_3::prodml23__PvtModelParameterKind kind, const std::string & name = "");
	};
}
