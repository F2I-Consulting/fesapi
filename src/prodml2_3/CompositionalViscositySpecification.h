...
namespace PRODML2_3_NS
{
	...
	public:
		 ...
		 */
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::prodml23__ThermodynamicPhase getThermodynamicPhase() const {
			return static_cast<gsoap_eml2_3::prodml23__AbstractCompositionalViscosityModel*>(gsoapProxy)->phase;
		}
		 ...
		 */
		DLL_IMPORT_OR_EXPORT void setThermodynamicPhase(gsoap_eml2_3::prodml23__ThermodynamicPhase phase) {
			static_cast<gsoap_eml2_3::prodml23__AbstractCompositionalViscosityModel*>(gsoapProxy)->phase = phase;
		}
	};
}
