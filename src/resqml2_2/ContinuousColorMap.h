...
namespace RESQML2_2_NS
{
	...
	public:
		...
		*/
		ContinuousColorMap(soap* soapContext, const std::string & guid, const std::string & title,
		...
		*/
		ContinuousColorMap(gsoap_eml2_2::resqml2__ContinuousColorMap* fromGsoap) :
		...
		*/
		...
		DLL_IMPORT_OR_EXPORT gsoap_eml2_2::resqml2__InterpolationDomain getInterpolationDomain();
		DLL_IMPORT_OR_EXPORT std::string getInterpolationDomainAsString();

		DLL_IMPORT_OR_EXPORT gsoap_eml2_2::resqml2__InterpolationMethod getInterpolationMethod();
		 ...
		 */
		DLL_IMPORT_OR_EXPORT void setNanHsvColor(double hue, double saturation, double value, double alpha = 1, std::string colorTitle = "");
		 ...
		 * @param title		color title. It is not set if empty string (default value)
		 */
		DLL_IMPORT_OR_EXPORT void setNanRgbColor(double red, double green, double blue, double alpha = 1, std::string colorTitle = "");
		 ...
		 * @param title		color title. It is not set if empty string (default value)
		 */
		DLL_IMPORT_OR_EXPORT void setNanRgbColor(unsigned int red, unsigned int green, unsigned int blue, double alpha = 1, std::string colorTitle = "");
	...
	protected:
		friend void COMMON_NS::GraphicalInformationSet::setContinuousColorMap(COMMON_NS::AbstractObject* targetObject, ContinuousColorMap* continuousColorMap, 
