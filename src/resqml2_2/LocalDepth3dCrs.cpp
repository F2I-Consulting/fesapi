	...
	gsoap_resqml2_0_1::eml20__LengthUom verticalUom, bool isUpOriented)
{
	...
	gsoapProxy2_3 = soap_new_resqml22__LocalDepth3dCrs(repo->getGsoapContext());
	_resqml22__LocalDepth3dCrs* local3dCrs = static_cast<_resqml22__LocalDepth3dCrs*>(gsoapProxy2_3);
