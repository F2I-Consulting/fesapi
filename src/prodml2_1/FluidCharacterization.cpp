...
SETTER_FLUID_COMPONENT_OPTIONAL_ATTRIBUTE_IMPL(PlusFluidComponent, StartingCarbonNumber, ULONG64, soap_new_ULONG64)
...
SETTER_FLUID_COMPONENT_OPTIONAL_ATTRIBUTE_IMPL(PseudoFluidComponent, StartingCarbonNumber, ULONG64, soap_new_ULONG64)
SETTER_FLUID_COMPONENT_OPTIONAL_ATTRIBUTE_IMPL(PseudoFluidComponent, EndingCarbonNumber, ULONG64, soap_new_ULONG64)
...
PvtSpecification* FluidCharacterization::setModelSpecification(unsigned int modelIndex, ModelSpecification kind)
{
