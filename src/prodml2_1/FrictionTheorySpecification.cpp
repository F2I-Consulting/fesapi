...
{
	prodml21__PrsvParameter* param = soap_new_prodml21__PrsvParameter(gsoapProxy->soap);
	static_cast<gsoap_eml2_2::prodml21__FrictionTheory*>(gsoapProxy)->PrsvParameter.push_back(param);
	param->a1 = a1;
	param->a2 = a2;
	param->b1 = b1;
	param->b2 = b2;
