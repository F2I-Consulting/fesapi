		...
		*/
		...
		time_t getCreation() const
		{
			if (static_cast<gsoap_witsml1_4_1_1::_witsml1__formationMarkers*>(collection)->formationMarker[0]->commonData->dTimCreation)
				return timeTools::timegm(static_cast<gsoap_witsml1_4_1_1::_witsml1__formationMarkers*>(collection)->formationMarker[0]->commonData->dTimCreation);
			else
				return -1;
		}
		time_t getLastUpdate() const
		{
			if (static_cast<gsoap_witsml1_4_1_1::_witsml1__formationMarkers*>(collection)->formationMarker[0]->commonData->dTimLastChange)
				return timeTools::timegm(static_cast<gsoap_witsml1_4_1_1::_witsml1__formationMarkers*>(collection)->formationMarker[0]->commonData->dTimLastChange);
			else
				return -1;
		}
