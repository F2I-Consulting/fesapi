...
namespace RESQML2_NS
{
	...
	protected:
		...
		*/
		...
		RockFluidOrganizationInterpretation(gsoap_eml2_2::_resqml22__RockFluidOrganizationInterpretation* fromGsoap) : AbstractOrganizationInterpretation(fromGsoap) {}
