...
namespace RESQML2_NS
{
	...
	protected:
		...
		*/
		RockFluidOrganizationInterpretation(gsoap_resqml2_0_1::_resqml20__StratigraphicOccurrenceInterpretation* fromGsoap) : AbstractOrganizationInterpretation(fromGsoap) {}
