...
namespace RESQML2_NS
{
	...
	protected:
		...
		*/
		...
		IjkGridNoGeometryRepresentation(gsoap_eml2_2::_resqml22__IjkGridRepresentation* fromGsoap) : AbstractIjkGridRepresentation(fromGsoap) {}
		...
		IjkGridNoGeometryRepresentation(gsoap_eml2_2::_resqml22__TruncatedIjkGridRepresentation* fromGsoap) : AbstractIjkGridRepresentation(fromGsoap) {}
	};
}
