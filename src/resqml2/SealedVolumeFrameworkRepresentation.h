...
namespace RESQML2_NS
{
	...
	public:
		 ...
		 */
		DLL_IMPORT_OR_EXPORT virtual uint64_t getFaceCountOfInternalShell(uint64_t regionIndex, uint64_t internalShellIndex) const = 0;
		 ...
		 */
		DLL_IMPORT_OR_EXPORT virtual RESQML2_NS::AbstractRepresentation* getRepOfExternalShellFace(uint64_t regionIndex, uint64_t faceIndex) = 0;
		 ...
		 */
		DLL_IMPORT_OR_EXPORT virtual RESQML2_NS::AbstractRepresentation* getRepOfInternalShellFace(uint64_t regionIndex, uint64_t internalShellIndex, uint64_t faceIndex) = 0;
		 ...
		 */
		DLL_IMPORT_OR_EXPORT virtual uint64_t getRepPatchIndexOfExternalShellFace(uint64_t regionIndex, uint64_t faceIndex) = 0;
		 ...
		 */
		DLL_IMPORT_OR_EXPORT virtual uint64_t getRepPatchIndexOfInternalShellFace(uint64_t regionIndex, uint64_t internalShellIndex, uint64_t faceIndex) = 0;
		 ...
		 * 			regionIndex of this framework.
		 */
		DLL_IMPORT_OR_EXPORT virtual bool getSideFlagOfExternalShellFace(uint64_t regionIndex, uint64_t faceIndex) = 0;
		 ...
		 */
		DLL_IMPORT_OR_EXPORT virtual bool getSideFlagOfInternalShellFace(uint64_t regionIndex, uint64_t internalShellIndex, uint64_t faceIndex) = 0;

		/** The standard XML tag without XML namespace for serializing this data object. */
		DLL_IMPORT_OR_EXPORT static constexpr char const* XML_TAG = "SealedVolumeFrameworkRepresentation";
