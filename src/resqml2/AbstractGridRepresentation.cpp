...
gsoap_eml2_2::resqml22__AbstractParentWindow* AbstractGridRepresentation::getParentWindow2_2() const
{
	if (gsoapProxy2_2 != nullptr) {
		return static_cast<gsoap_eml2_2::resqml22__AbstractGridRepresentation*>(gsoapProxy2_2)->ParentWindow;
	}
...
COMMON_NS::DataObjectReference AbstractGridRepresentation::getParentGridDor() const
{
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (parentWindow != nullptr) {
			switch (parentWindow->soap_type()) {
			case SOAP_TYPE_gsoap_eml2_2_resqml22__IjkParentWindow : return COMMON_NS::DataObjectReference(static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow)->ParentIjkGridRepresentation);
			case SOAP_TYPE_gsoap_eml2_2_resqml22__ColumnLayerParentWindow : return COMMON_NS::DataObjectReference(static_cast<gsoap_eml2_2::resqml22__ColumnLayerParentWindow*>(parentWindow)->ParentColumnLayerGridRepresentation);
			case SOAP_TYPE_gsoap_eml2_2_resqml22__CellParentWindow : return COMMON_NS::DataObjectReference(static_cast<gsoap_eml2_2::resqml22__CellParentWindow*>(parentWindow)->ParentGridRepresentation);
			default: throw logic_error("Unexpected parent window type.");
			}
		}
	}
...
gsoap_eml2_2::resqml22__Regrid* AbstractGridRepresentation::createRegrid2_2(unsigned int indexRegridStart, unsigned int * childCellCountPerInterval, unsigned int * parentCellCountPerInterval, unsigned int intervalCount, double * childCellWeights,
	const std::string & dimension, COMMON_NS::AbstractHdfProxy * proxy, bool forceConstantCellCountPerInterval)
{
	gsoap_eml2_2::resqml22__Regrid* regrid = gsoap_eml2_2::soap_new_resqml22__Regrid(gsoapProxy2_2->soap);
	regrid->InitialIndexOnParentGrid = indexRegridStart;
	regrid->Intervals = gsoap_eml2_2::soap_new_resqml22__Intervals(gsoapProxy2_2->soap);
	regrid->Intervals->IntervalCount = intervalCount;
	...
	if (intervalCount == 0) {
		...
		gsoap_eml2_2::eml22__IntegerConstantArray* xmlChildCountPerInterval = gsoap_eml2_2::soap_new_eml22__IntegerConstantArray(gsoapProxy2_2->soap);
		xmlChildCountPerInterval->Value = *childCellCountPerInterval;
		xmlChildCountPerInterval->Count = intervalCount;
		regrid->Intervals->ChildCountPerInterval = xmlChildCountPerInterval;

		gsoap_eml2_2::eml22__IntegerConstantArray* xmlParentCountPerInterval = gsoap_eml2_2::soap_new_eml22__IntegerConstantArray(gsoapProxy2_2->soap);
		xmlParentCountPerInterval->Value = *parentCellCountPerInterval;
		xmlParentCountPerInterval->Count = intervalCount;
		regrid->Intervals->ParentCountPerInterval = xmlParentCountPerInterval;
	}
		...
		gsoap_eml2_2::eml22__IntegerExternalArray* hdf5ChildCountPerInterval = gsoap_eml2_2::soap_new_eml22__IntegerExternalArray(gsoapProxy2_2->soap);
		regrid->Intervals->ChildCountPerInterval = hdf5ChildCountPerInterval;
		hdf5ChildCountPerInterval->NullValue = (numeric_limits<unsigned int>::max)();
		hdf5ChildCountPerInterval->Values = gsoap_eml2_2::soap_new_eml22__ExternalDataset(gsoapProxy2_2->soap);
		...
		dsPart->PathInExternalFile = "/RESQML/" + gsoapProxy2_2->uuid + "/ParentWindow_" + dimension + "Regrid_ChildCountPerInterval";
		hdf5ChildCountPerInterval->Values->ExternalFileProxy.push_back(dsPart);

		gsoap_eml2_2::eml22__IntegerExternalArray* hdf5ParentCountPerInterval = gsoap_eml2_2::soap_new_eml22__IntegerExternalArray(gsoapProxy2_2->soap);
		regrid->Intervals->ParentCountPerInterval = hdf5ParentCountPerInterval;
		hdf5ParentCountPerInterval->NullValue = (numeric_limits<unsigned int>::max)();
		hdf5ParentCountPerInterval->Values = gsoap_eml2_2::soap_new_eml22__ExternalDataset(gsoapProxy2_2->soap);
		dsPart = gsoap_eml2_2::soap_new_eml22__ExternalDatasetPart(gsoapProxy2_2->soap);
		dsPart->EpcExternalPartReference = proxy->newEml22Reference();
		dsPart->PathInExternalFile = "/RESQML/" + gsoapProxy2_2->uuid + "/ParentWindow_" + dimension + "Regrid_ParentCountPerInterval";
		hdf5ChildCountPerInterval->Values->ExternalFileProxy.push_back(dsPart);

		// HDF
		hsize_t numValues = intervalCount;
		proxy->writeArrayNd(gsoapProxy2_2->uuid, "ParentWindow_" + dimension + "Regrid_ChildCountPerInterval", H5T_NATIVE_UINT, childCellCountPerInterval, &numValues, 1);
		proxy->writeArrayNd(gsoapProxy2_2->uuid, "ParentWindow_" + dimension + "Regrid_ParentCountPerInterval", H5T_NATIVE_UINT, parentCellCountPerInterval, &numValues, 1);
	}
	...
	if (childCellWeights != nullptr) {
		...
		gsoap_eml2_2::eml22__FloatingPointExternalArray* hdf5ChildCellWeights = gsoap_eml2_2::soap_new_eml22__FloatingPointExternalArray(gsoapProxy2_2->soap);
		regrid->Intervals->ChildCellWeights = hdf5ChildCellWeights;
		hdf5ChildCellWeights->Values = gsoap_eml2_2::soap_new_eml22__ExternalDataset(gsoapProxy2_2->soap);
		auto dsPart = gsoap_eml2_2::soap_new_eml22__ExternalDatasetPart(gsoapProxy2_2->soap);
		dsPart->EpcExternalPartReference = proxy->newEml22Reference();
		dsPart->PathInExternalFile = "/RESQML/" + gsoapProxy2_2->uuid + "/ParentWindow_" + dimension + "Regrid_ChildCellWeights";
...
void AbstractGridRepresentation::setParentWindow(ULONG64 * cellIndices, ULONG64 cellIndexCount, UnstructuredGridRepresentation* parentGrid, COMMON_NS::AbstractHdfProxy * proxy)
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		auto rep = static_cast<gsoap_eml2_2::resqml22__AbstractGridRepresentation*>(gsoapProxy2_2);

		gsoap_eml2_2::resqml22__CellParentWindow* cpw = gsoap_eml2_2::soap_new_resqml22__CellParentWindow(rep->soap);
		rep->ParentWindow = cpw;

		cpw->ParentGridRepresentation = parentGrid->newEml22Reference();
		if (cellIndexCount > 1) {
			if (proxy == nullptr) {
				proxy = getRepository()->getDefaultHdfProxy();
				if (proxy == nullptr) {
			...
			auto hdf5CellIndices = gsoap_eml2_2::soap_new_eml22__IntegerExternalArray(rep->soap);
			cpw->CellIndices = hdf5CellIndices;

			hdf5CellIndices->NullValue = (numeric_limits<ULONG64>::max)();
			hdf5CellIndices->Values = gsoap_eml2_2::soap_new_eml22__ExternalDataset(rep->soap);
			auto dsPart = gsoap_eml2_2::soap_new_eml22__ExternalDatasetPart(rep->soap);
			dsPart->EpcExternalPartReference = proxy->newEml22Reference();
			dsPart->PathInExternalFile = "/RESQML/" + gsoapProxy2_2->uuid + "/ParentWindow_CellIndices";
			hdf5CellIndices->Values->ExternalFileProxy.push_back(dsPart);

			// HDF
			hsize_t numValues = cellIndexCount;
			proxy->writeArrayNdOfGSoapULong64Values(gsoapProxy2_2->uuid, "ParentWindow_CellIndices", cellIndices, &numValues, 1);
		}
		else { // cellIndexCount == 1
			auto xmlCellIndices = gsoap_eml2_2::soap_new_eml22__IntegerConstantArray(rep->soap);
			xmlCellIndices->Value = *cellIndices;
			xmlCellIndices->Count = 1;
			cpw->CellIndices = xmlCellIndices;
		}
	...
	COMMON_NS::AbstractHdfProxy * proxy, double * childCellWeights)
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		gsoap_eml2_2::resqml22__ColumnLayerParentWindow* clpw = gsoap_eml2_2::soap_new_resqml22__ColumnLayerParentWindow(rep->soap);
		rep->ParentWindow = clpw;

		clpw->ParentColumnLayerGridRepresentation = parentGrid->newEml22Reference();
		...
		if (columnIndexCount > 1)
		{
			...
			gsoap_eml2_2::eml22__IntegerExternalArray* hdf5ColumnIndices = gsoap_eml2_2::soap_new_eml22__IntegerExternalArray(rep->soap);
			clpw->ColumnIndices = hdf5ColumnIndices;

			hdf5ColumnIndices->NullValue = (numeric_limits<unsigned int>::max)();
			hdf5ColumnIndices->Values = gsoap_eml2_2::soap_new_eml22__ExternalDataset(rep->soap);
			auto dsPart = gsoap_eml2_2::soap_new_eml22__ExternalDatasetPart(rep->soap);
			dsPart->EpcExternalPartReference = proxy->newEml22Reference();
			dsPart->PathInExternalFile = "/RESQML/" + gsoapProxy2_2->uuid + "/ParentWindow_ColumnIndices";
		...
		{
			gsoap_eml2_2::eml22__IntegerConstantArray* xmlColumnIndices = gsoap_eml2_2::soap_new_eml22__IntegerConstantArray(rep->soap);
			xmlColumnIndices->Value = *columnIndices;
			xmlColumnIndices->Count = 1;
			clpw->ColumnIndices = xmlColumnIndices;
		}
...
void AbstractGridRepresentation::setParentWindow(
	...
	AbstractIjkGridRepresentation* parentGrid, COMMON_NS::AbstractHdfProxy * proxy, double * iChildCellWeights, double * jChildCellWeights, double * kChildCellWeights)
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		auto ijkpw = gsoap_eml2_2::soap_new_resqml22__IjkParentWindow(gsoapProxy2_2->soap);
		static_cast<gsoap_eml2_2::resqml22__AbstractGridRepresentation*>(gsoapProxy2_2)->ParentWindow = ijkpw;

		ijkpw->ParentIjkGridRepresentation = parentGrid->newEml22Reference();
...
void AbstractGridRepresentation::setForcedNonRegridedParentCell(ULONG64 * cellIndices, ULONG64 cellIndexCount)
{
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (parentWindow != nullptr)
		{
			gsoap_eml2_2::eml22__AbstractIntegerArray* xmlCellIndices = nullptr;

			COMMON_NS::AbstractHdfProxy * proxy = getRepository()->getDefaultHdfProxy();
			if (cellIndexCount > 1 && proxy != nullptr)
			{
				getRepository()->addRelationship(this, proxy);
				xmlCellIndices = gsoap_eml2_2::soap_new_eml22__IntegerExternalArray(parentWindow->soap);
				static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(xmlCellIndices)->NullValue = (numeric_limits<ULONG64>::max)();
				static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(xmlCellIndices)->Values = gsoap_eml2_2::soap_new_eml22__ExternalDataset(parentWindow->soap);
				auto dsPart = gsoap_eml2_2::soap_new_eml22__ExternalDatasetPart(parentWindow->soap);
				dsPart->EpcExternalPartReference = proxy->newEml22Reference();
				dsPart->PathInExternalFile = "/RESQML/" + gsoapProxy2_2->uuid + "/ParentWindow_CellIndices";
				static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(xmlCellIndices)->Values->ExternalFileProxy.push_back(dsPart);
			...
			{
				xmlCellIndices = gsoap_eml2_2::soap_new_eml22__IntegerConstantArray(parentWindow->soap);
				static_cast<gsoap_eml2_2::eml22__IntegerConstantArray*>(xmlCellIndices)->Value = *cellIndices;
				static_cast<gsoap_eml2_2::eml22__IntegerConstantArray*>(xmlCellIndices)->Count = 1;
			}
			else if (cellIndexCount == 0)
				throw invalid_argument("Cannot force an empty list of cells.");
			else
			...
			switch (parentWindow->soap_type()) {
			case SOAP_TYPE_gsoap_eml2_2_resqml22__IjkParentWindow: static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow)->OmitParentCells = xmlCellIndices; break;
			case SOAP_TYPE_gsoap_eml2_2_resqml22__ColumnLayerParentWindow: static_cast<gsoap_eml2_2::resqml22__ColumnLayerParentWindow*>(parentWindow)->OmitParentCells = xmlCellIndices; break;
			default : throw invalid_argument("You can only force parent cell on a ijk or column layer parent window.");
			}
		}
		else {
...
bool AbstractGridRepresentation::hasForcedNonRegridedParentCell() const
{
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (parentWindow != nullptr) {
			switch (parentWindow->soap_type()) {
			case SOAP_TYPE_gsoap_eml2_2_resqml22__IjkParentWindow: return static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow)->OmitParentCells != nullptr;
			case SOAP_TYPE_gsoap_eml2_2_resqml22__ColumnLayerParentWindow: return static_cast<gsoap_eml2_2::resqml22__ColumnLayerParentWindow*>(parentWindow)->OmitParentCells != nullptr;
			default: return false;
			}
		}
		else {
	...
	const std::string& volumeUom, double * overlapVolumes)
{
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (parentWindow != nullptr)
		{
			...
			{
				getRepository()->addRelationship(this, proxy);
				parentWindow->CellOverlap = gsoap_eml2_2::soap_new_resqml22__CellOverlap(gsoapProxy2_2->soap);

				gsoap_eml2_2::eml22__IntegerExternalArray* hdf5CellPairs = gsoap_eml2_2::soap_new_eml22__IntegerExternalArray(parentWindow->soap);
				parentWindow->CellOverlap->__CellOverlap_sequence = gsoap_eml2_2::soap_new___resqml22__CellOverlap_sequence(parentWindow->soap);
				parentWindow->CellOverlap->__CellOverlap_sequence->Count = parentChildCellPairCount;
				parentWindow->CellOverlap->__CellOverlap_sequence->ParentChildCellPairs = hdf5CellPairs;
				hdf5CellPairs->NullValue = (numeric_limits<ULONG64>::max)();
				hdf5CellPairs->Values = gsoap_eml2_2::soap_new_eml22__ExternalDataset(parentWindow->soap);
				auto dsPart = gsoap_eml2_2::soap_new_eml22__ExternalDatasetPart(parentWindow->soap);
				dsPart->EpcExternalPartReference = proxy->newEml22Reference();
				dsPart->PathInExternalFile = "/RESQML/" + gsoapProxy2_2->uuid + "/ParentWindow_CellOverlap";
				hdf5CellPairs->Values->ExternalFileProxy.push_back(dsPart);

				// HDF
				hsize_t numValues[] = { parentChildCellPairCount, 2 };
				proxy->writeArrayNdOfGSoapULong64Values(gsoapProxy2_2->uuid, "ParentWindow_CellOverlap", parentChildCellPair, numValues, 2);
			}
			else if (parentChildCellPairCount == 0)
				throw invalid_argument("Cannot give cell overlap information with an empty list of cell pairs.");
			else
			...
			if (overlapVolumes != nullptr)
			{
				parentWindow->CellOverlap->__CellOverlap_sequence->OverlapVolume = gsoap_eml2_2::soap_new_resqml22__OverlapVolume(parentWindow->soap);
				parentWindow->CellOverlap->__CellOverlap_sequence->OverlapVolume->__OverlapVolume_sequence = gsoap_eml2_2::soap_new___resqml22__OverlapVolume_sequence(parentWindow->soap);
				gsoap_eml2_2::eml22__VolumeUom uomEnum;
				gsoap_eml2_2::soap_s2eml22__VolumeUom(parentWindow->soap, volumeUom.c_str(), &uomEnum);
				parentWindow->CellOverlap->__CellOverlap_sequence->OverlapVolume->__OverlapVolume_sequence->VolumeUom = uomEnum;

				gsoap_eml2_2::eml22__FloatingPointExternalArray* hdf5OverlapVolume = gsoap_eml2_2::soap_new_eml22__FloatingPointExternalArray(parentWindow->soap);
				parentWindow->CellOverlap->__CellOverlap_sequence->OverlapVolume->__OverlapVolume_sequence->OverlapVolumes = hdf5OverlapVolume;
				hdf5OverlapVolume->Values = gsoap_eml2_2::soap_new_eml22__ExternalDataset(parentWindow->soap);
				auto dsPart = gsoap_eml2_2::soap_new_eml22__ExternalDatasetPart(parentWindow->soap);
				dsPart->EpcExternalPartReference = proxy->newEml22Reference();
				dsPart->PathInExternalFile = "/RESQML/" + gsoapProxy2_2->uuid + "/ParentWindow_OverlapVolume";
				hdf5OverlapVolume->Values->ExternalFileProxy.push_back(dsPart);

				// HDF
				hsize_t numValues = parentChildCellPairCount;
				proxy->writeArrayNdOfDoubleValues(gsoapProxy2_2->uuid, "ParentWindow_OverlapVolume", overlapVolumes, &numValues, 1);
			}
		}
		else {
			throw invalid_argument("You cannot give cell overlap information without a parent window. Set the parent window first please.");
...
LONG64 AbstractGridRepresentation::getParentCellIndexCount() const
{
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (parentWindow != nullptr)
		{
			if (parentWindow->soap_type() == SOAP_TYPE_gsoap_eml2_2_resqml22__CellParentWindow)
			{
				auto cpw = static_cast<gsoap_eml2_2::resqml22__CellParentWindow*>(parentWindow);
				if (cpw->CellIndices->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerExternalArray)
				{
					gsoap_eml2_2::eml22__ExternalDataset const * dataset = static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(cpw->CellIndices)->Values;
...
LONG64 AbstractGridRepresentation::getParentColumnIndexCount() const
{
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (parentWindow != nullptr)
		{
			if (parentWindow->soap_type() == SOAP_TYPE_gsoap_eml2_2_resqml22__ColumnLayerParentWindow)
			{
				auto cpw = static_cast<gsoap_eml2_2::resqml22__ColumnLayerParentWindow*>(parentWindow);
				if (cpw->ColumnIndices->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerExternalArray) {
					gsoap_eml2_2::eml22__ExternalDataset const * dataset = static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(cpw->ColumnIndices)->Values;
					COMMON_NS::AbstractHdfProxy * hdfProxy = getHdfProxyFromDataset(dataset->ExternalFileProxy[0]);
					return hdfProxy->getElementCount(dataset->ExternalFileProxy[0]->PathInExternalFile);
				}
				else
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (parentWindow != nullptr)
		{
			if (parentWindow->soap_type() == SOAP_TYPE_gsoap_eml2_2_resqml22__IjkParentWindow)
			{
				if (dimension == 'i' || dimension == 'I')
				{
					return static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow)->IRegrid->InitialIndexOnParentGrid;
				}
				else if (dimension == 'j' || dimension == 'J')
				{
					return static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow)->JRegrid->InitialIndexOnParentGrid;
				}
				else if (dimension == 'k' || dimension == 'K')
				{
					return static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow)->KRegrid->InitialIndexOnParentGrid;
				}
				else
					throw invalid_argument("Only i, j or k dimension can be accessed for an IJK Parent Window.");
			}
			else if (parentWindow->soap_type() == SOAP_TYPE_gsoap_eml2_2_resqml22__ColumnLayerParentWindow)
			{
				if (dimension == 'k' || dimension == 'K')
				{
					return static_cast<gsoap_eml2_2::resqml22__ColumnLayerParentWindow*>(parentWindow)->KRegrid->InitialIndexOnParentGrid;
				}
				else
					throw invalid_argument("Only k dimension can be accessed for a ColumnLayer Parent Window.");
			}
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (parentWindow != nullptr)
		{
			if (parentWindow->soap_type() == SOAP_TYPE_gsoap_eml2_2_resqml22__IjkParentWindow)
			{
				if (dimension == 'i' || dimension == 'I')
				{
					return static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow)->IRegrid->Intervals != nullptr
						? static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow)->IRegrid->Intervals->IntervalCount
						: 0;
				}
				else if (dimension == 'j' || dimension == 'J')
				{
					return static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow)->JRegrid->Intervals != nullptr
						? static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow)->JRegrid->Intervals->IntervalCount
						: 0;
				}
				else if (dimension == 'k' || dimension == 'K')
				{
					return static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow)->KRegrid->Intervals != nullptr
						? static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow)->KRegrid->Intervals->IntervalCount
						: 0;
				}
				else
					throw invalid_argument("Only i, j or k dimension can be accessed for an IJK Parent Window.");
			...
			else if (parentWindow->soap_type() == SOAP_TYPE_gsoap_eml2_2_resqml22__ColumnLayerParentWindow)
			{
				if (dimension == 'k' || dimension == 'K')
				{
					return static_cast<gsoap_eml2_2::resqml22__ColumnLayerParentWindow*>(parentWindow)->KRegrid->Intervals != nullptr
						? static_cast<gsoap_eml2_2::resqml22__ColumnLayerParentWindow*>(parentWindow)->KRegrid->Intervals->IntervalCount
						: 0;
				}
				else
					throw invalid_argument("Only k dimension can be accessed for a ColumnLayer Parent Window.");
...
gsoap_eml2_2::eml22__AbstractIntegerArray* AbstractGridRepresentation::getCellCountPerInterval2_2(char dimension, bool childVsParentCellCount) const
{
	auto parentWindow = getParentWindow2_2();

	if (parentWindow != nullptr) {
		if (parentWindow->soap_type() == SOAP_TYPE_gsoap_eml2_2_resqml22__IjkParentWindow) {
			gsoap_eml2_2::resqml22__IjkParentWindow const * const ijkpw = static_cast<const gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow);
			gsoap_eml2_2::resqml22__Regrid const * regrid = nullptr;
			if (dimension == 'i' || dimension == 'I') {
				regrid = ijkpw->IRegrid;
			}
			else if (dimension == 'j' || dimension == 'J') {
			...
			if (dimension == 'k' || dimension == 'K') {
				const gsoap_eml2_2::resqml22__ColumnLayerParentWindow* const clpw = static_cast<const gsoap_eml2_2::resqml22__ColumnLayerParentWindow* const>(parentWindow);
				if (clpw->KRegrid->Intervals != nullptr) {
					return childVsParentCellCount ? clpw->KRegrid->Intervals->ChildCountPerInterval : clpw->KRegrid->Intervals->ParentCountPerInterval;
				}
				else {
...
bool AbstractGridRepresentation::isRegridCellCountPerIntervalConstant(char dimension, bool childVsParentCellCount) const {
	if (gsoapProxy2_0_1 != nullptr) {
		...
		gsoap_eml2_2::eml22__AbstractIntegerArray* cellCountPerInterval = getCellCountPerInterval2_2(dimension, childVsParentCellCount);
		if (cellCountPerInterval->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerConstantArray) {
			return true;
		}
		else if (cellCountPerInterval->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerExternalArray) {
			const ULONG64 intervalCount = getRegridIntervalCount(dimension);
			std::unique_ptr<ULONG64[]> values(new ULONG64[intervalCount]);
			getRegridCellCountPerInterval(dimension, values.get(), childVsParentCellCount);
...
ULONG64 AbstractGridRepresentation::getRegridConstantCellCountPerInterval(char dimension, bool childVsParentCellCount) const {
	if (gsoapProxy2_0_1 != nullptr) {
		...
		gsoap_eml2_2::eml22__AbstractIntegerArray const* cellCountPerInterval = getCellCountPerInterval2_2(dimension, childVsParentCellCount);
		switch (cellCountPerInterval->soap_type()) {
		case SOAP_TYPE_gsoap_eml2_2_eml22__IntegerConstantArray : return static_cast<const gsoap_eml2_2::eml22__IntegerConstantArray* const>(cellCountPerInterval)->Value;
		case SOAP_TYPE_gsoap_eml2_2_eml22__IntegerExternalArray: {
			const ULONG64 intervalCount = getRegridIntervalCount(dimension);
			std::unique_ptr<ULONG64[]> values(new ULONG64[intervalCount]);
			getRegridCellCountPerInterval(dimension, values.get(), childVsParentCellCount);
			ULONG64 result = values[0];
...
void AbstractGridRepresentation::getRegridCellCountPerInterval(char dimension, ULONG64 * childCellCountPerInterval, bool childVsParentCellCount) const
{
	if (gsoapProxy2_0_1 != nullptr) {
		...
		gsoap_eml2_2::eml22__AbstractIntegerArray const* childCountPerInterval = getCellCountPerInterval2_2(dimension, childVsParentCellCount);
		switch (childCountPerInterval->soap_type()) {
		case SOAP_TYPE_gsoap_eml2_2_eml22__IntegerConstantArray:
			for (ULONG64 i = 0; i < static_cast<const gsoap_eml2_2::eml22__IntegerConstantArray*>(childCountPerInterval)->Count; ++i) {
				childCellCountPerInterval[i] = static_cast<const gsoap_eml2_2::eml22__IntegerConstantArray*>(childCountPerInterval)->Value;
			}
			break;
		case SOAP_TYPE_gsoap_eml2_2_eml22__IntegerExternalArray: {
			gsoap_eml2_2::eml22__ExternalDataset const * dataset = static_cast<gsoap_eml2_2::eml22__IntegerExternalArray const *>(childCountPerInterval)->Values;
...
bool AbstractGridRepresentation::hasRegridChildCellWeights(char dimension) const
{
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (parentWindow != nullptr) {
			if (parentWindow->soap_type() == SOAP_TYPE_gsoap_eml2_2_resqml22__IjkParentWindow)
			{
				return hasRegridChildCellWeightsInIjkParentWindow(static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow), dimension);
			}
			else if (parentWindow->soap_type() == SOAP_TYPE_gsoap_eml2_2_resqml22__ColumnLayerParentWindow)
			{
				if (dimension == 'k' || dimension == 'K')
				{
					gsoap_eml2_2::resqml22__ColumnLayerParentWindow* clpw = static_cast<gsoap_eml2_2::resqml22__ColumnLayerParentWindow*>(parentWindow);
					if (clpw->KRegrid->Intervals != nullptr) {
						return clpw->KRegrid->Intervals->ChildCellWeights != nullptr;
					}
					else {
...
void AbstractGridRepresentation::getRegridChildCellWeights(char dimension, double * childCellWeights) const
{
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (parentWindow != nullptr) {
			if (parentWindow->soap_type() == SOAP_TYPE_gsoap_eml2_2_resqml22__IjkParentWindow) {
				gsoap_eml2_2::resqml22__IjkParentWindow* ijkpw = static_cast<gsoap_eml2_2::resqml22__IjkParentWindow*>(parentWindow);
				if (dimension == 'i' || dimension == 'I') {
					if (ijkpw->IRegrid->Intervals != nullptr && ijkpw->IRegrid->Intervals->ChildCellWeights != nullptr) {
						if (dynamic_cast<gsoap_eml2_2::eml22__FloatingPointExternalArray*>(ijkpw->IRegrid->Intervals->ChildCellWeights) != nullptr) {
							gsoap_eml2_2::eml22__ExternalDatasetPart const * dsPart = static_cast<gsoap_eml2_2::eml22__FloatingPointExternalArray*>(ijkpw->IRegrid->Intervals->ChildCellWeights)->Values->ExternalFileProxy[0];
					...
					if (ijkpw->JRegrid->Intervals != nullptr && ijkpw->JRegrid->Intervals->ChildCellWeights != nullptr) {
						if (dynamic_cast<gsoap_eml2_2::eml22__FloatingPointExternalArray*>(ijkpw->JRegrid->Intervals->ChildCellWeights) != nullptr) {
							gsoap_eml2_2::eml22__ExternalDatasetPart const * dsPart = static_cast<gsoap_eml2_2::eml22__FloatingPointExternalArray*>(ijkpw->JRegrid->Intervals->ChildCellWeights)->Values->ExternalFileProxy[0];
							getHdfProxyFromDataset(dsPart)->readArrayNdOfDoubleValues(dsPart->PathInExternalFile, childCellWeights);
						}
						else
							throw invalid_argument("ChildCellWeights should be in HDF5 file.");
					...
					if (ijkpw->KRegrid->Intervals != nullptr && ijkpw->KRegrid->Intervals->ChildCellWeights != nullptr) {
						if (dynamic_cast<gsoap_eml2_2::eml22__FloatingPointExternalArray*>(ijkpw->KRegrid->Intervals->ChildCellWeights) != nullptr) {
							gsoap_eml2_2::eml22__ExternalDatasetPart const * dsPart = static_cast<gsoap_eml2_2::eml22__FloatingPointExternalArray*>(ijkpw->KRegrid->Intervals->ChildCellWeights)->Values->ExternalFileProxy[0];
							getHdfProxyFromDataset(dsPart)->readArrayNdOfDoubleValues(dsPart->PathInExternalFile, childCellWeights);
						}
						else
							throw invalid_argument("ChildCellWeights should be in HDF5 file.");
				...
				if (dimension == 'k' || dimension == 'K') {
					gsoap_eml2_2::resqml22__ColumnLayerParentWindow* clpw = static_cast<gsoap_eml2_2::resqml22__ColumnLayerParentWindow*>(parentWindow);
					if (clpw->KRegrid->Intervals != nullptr  && clpw->KRegrid->Intervals->ChildCellWeights != nullptr) {
						if (dynamic_cast<gsoap_eml2_2::eml22__FloatingPointExternalArray*>(clpw->KRegrid->Intervals->ChildCellWeights) != nullptr) {
							gsoap_eml2_2::eml22__ExternalDatasetPart const * dsPart = static_cast<gsoap_eml2_2::eml22__FloatingPointExternalArray*>(clpw->KRegrid->Intervals->ChildCellWeights)->Values->ExternalFileProxy[0];
							getHdfProxyFromDataset(dsPart)->readArrayNdOfDoubleValues(dsPart->PathInExternalFile, childCellWeights);
						}
						else
							throw invalid_argument("ChildCellWeights should be in HDF5 file.");
...
void AbstractGridRepresentation::setCellAssociationWithRockFluidOrganizationInterpretation(ULONG64 * rockFluidUnitIndices, ULONG64 nullValue, RESQML2_NS::RockFluidOrganizationInterpretation* rockfluidOrgInterp)
{
	...
	// ************ HDF *************
	const hsize_t dim = getCellCount();
	proxy->writeArrayNd(getUuid(), "CellFluidPhaseUnits", H5T_NATIVE_ULLONG, rockFluidUnitIndices, &dim, 1);
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		gsoap_eml2_2::resqml22__AbstractGridRepresentation* rep = static_cast<gsoap_eml2_2::resqml22__AbstractGridRepresentation*>(gsoapProxy2_2);
		rep->CellFluidPhaseUnits = gsoap_eml2_2::soap_new_resqml22__CellFluidPhaseUnits(rep->soap);
		rep->CellFluidPhaseUnits->RockFluidOrganizationInterpretation = rockfluidOrgInterp->newEml22Reference();

		rep->CellFluidPhaseUnits->PhaseUnitIndices = gsoap_eml2_2::soap_new_eml22__JaggedArray(rep->soap);
		// element XML
		gsoap_eml2_2::eml22__IntegerExternalArray* elementDataset = gsoap_eml2_2::soap_new_eml22__IntegerExternalArray(rep->soap);
		elementDataset->NullValue = nullValue;
		elementDataset->Values = gsoap_eml2_2::soap_new_eml22__ExternalDataset(gsoapProxy2_2->soap);
		auto dsPart = gsoap_eml2_2::soap_new_eml22__ExternalDatasetPart(gsoapProxy2_2->soap);
		dsPart->EpcExternalPartReference = proxy->newEml22Reference();
		dsPart->PathInExternalFile = "/RESQML/" + rep->uuid + "/CellFluidPhaseUnits";
		elementDataset->Values->ExternalFileProxy.push_back(dsPart);
		rep->CellFluidPhaseUnits->PhaseUnitIndices->Elements = elementDataset;

		// cumulative XML
		gsoap_eml2_2::eml22__IntegerLatticeArray* cumulativeDataset = gsoap_eml2_2::soap_new_eml22__IntegerLatticeArray(rep->soap);
		cumulativeDataset->StartValue = 1;
		gsoap_eml2_2::eml22__IntegerConstantArray* constantArray = gsoap_eml2_2::soap_new_eml22__IntegerConstantArray(rep->soap);
...
COMMON_NS::DataObjectReference AbstractGridRepresentation::getStratigraphicOrganizationInterpretationDor() const
{
	if (gsoapProxy2_0_1 != nullptr) {
		...
		return static_cast<gsoap_eml2_2::resqml22__AbstractGridRepresentation*>(gsoapProxy2_2)->IntervalStratigraphicUnits == nullptr
			? COMMON_NS::DataObjectReference()
			: COMMON_NS::DataObjectReference(static_cast<gsoap_eml2_2::resqml22__AbstractGridRepresentation*>(gsoapProxy2_2)->IntervalStratigraphicUnits->StratigraphicOrganizationInterpretation);
	}
...
COMMON_NS::DataObjectReference AbstractGridRepresentation::getRockFluidOrganizationInterpretationDor() const
{
	if (gsoapProxy2_0_1 != nullptr) {
		...
		return static_cast<gsoap_eml2_2::resqml22__AbstractGridRepresentation*>(gsoapProxy2_2)->CellFluidPhaseUnits == nullptr
			? COMMON_NS::DataObjectReference()
			: COMMON_NS::DataObjectReference(static_cast<gsoap_eml2_2::resqml22__AbstractGridRepresentation*>(gsoapProxy2_2)->CellFluidPhaseUnits->RockFluidOrganizationInterpretation);
	}
...
ULONG64 AbstractGridRepresentation::getCellFluidPhaseUnitIndices(ULONG64 * rockFluidUnitIndices)
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		auto rep = static_cast<gsoap_eml2_2::resqml22__AbstractGridRepresentation*>(gsoapProxy2_2);
		if (rep->CellFluidPhaseUnits->PhaseUnitIndices->CumulativeLength->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerLatticeArray) {
			gsoap_eml2_2::eml22__IntegerLatticeArray* latticeArray = static_cast<gsoap_eml2_2::eml22__IntegerLatticeArray*>(rep->CellFluidPhaseUnits->PhaseUnitIndices->CumulativeLength);
			if (latticeArray->StartValue == 1 && latticeArray->Offset.size() == 1 &&
				...
				auto dsPart = static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(rep->CellFluidPhaseUnits->PhaseUnitIndices->Elements)->Values->ExternalFileProxy[0];
				COMMON_NS::AbstractHdfProxy * hdfProxy = getHdfProxyFromDataset(dsPart);
				hdfProxy->readArrayNdOfULongValues(dsPart->PathInExternalFile, rockFluidUnitIndices);
				return static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(rep->CellFluidPhaseUnits->PhaseUnitIndices->Elements)->NullValue;
			}
		}
...
ULONG64 AbstractGridRepresentation::getTruncatedFaceCount() const
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		gsoap_eml2_2::resqml22__AbstractTruncatedColumnLayerGridRepresentation* rep = static_cast<gsoap_eml2_2::resqml22__AbstractTruncatedColumnLayerGridRepresentation*>(gsoapProxy2_2);
...
void AbstractGridRepresentation::getNodeIndicesOfTruncatedFaces(ULONG64 * nodeIndices) const
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (rep->TruncationCellPatch->NodesPerTruncationFace->Elements->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerExternalArray)
		{
			auto dataset = static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(rep->TruncationCellPatch->NodesPerTruncationFace->Elements)->Values->ExternalFileProxy[0];
			COMMON_NS::AbstractHdfProxy * hdfProxy = getHdfProxyFromDataset(dataset);
...
void AbstractGridRepresentation::getCumulativeNodeCountPerTruncatedFace(ULONG64 * nodeCountPerFace) const
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (rep->TruncationCellPatch->NodesPerTruncationFace->CumulativeLength->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerExternalArray)
		{
			auto dsPart = static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(rep->TruncationCellPatch->NodesPerTruncationFace->CumulativeLength)->Values->ExternalFileProxy[0];
			COMMON_NS::AbstractHdfProxy * hdfProxy = getHdfProxyFromDataset(dsPart);
			hdfProxy->readArrayNdOfULongValues(dsPart->PathInExternalFile, nodeCountPerFace);
		}
		else if (rep->TruncationCellPatch->NodesPerTruncationFace->CumulativeLength->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerLatticeArray)
		{
			nodeCountPerFace[0] = static_cast<gsoap_eml2_2::eml22__IntegerLatticeArray*>(rep->TruncationCellPatch->NodesPerTruncationFace->CumulativeLength)->StartValue;
			const LONG64 offsetValue = static_cast<gsoap_eml2_2::eml22__IntegerLatticeArray*>(rep->TruncationCellPatch->NodesPerTruncationFace->CumulativeLength)->Offset[0]->Value;
			const ULONG64 faceCount = getTruncatedFaceCount();
			for (ULONG64 nodeCountPerFaceIndex = 1; nodeCountPerFaceIndex < faceCount; ++nodeCountPerFaceIndex) {
				nodeCountPerFace[nodeCountPerFaceIndex] = nodeCountPerFace[nodeCountPerFaceIndex - 1] + offsetValue;
			}
		}
		else if (rep->TruncationCellPatch->NodesPerTruncationFace->CumulativeLength->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerConstantArray)
		{
			throw range_error("The *cumulative* length of nodes count per cells cannot be constant.");
		}
	}
...
ULONG64 AbstractGridRepresentation::getTruncatedCellCount() const
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		return static_cast<gsoap_eml2_2::resqml22__AbstractTruncatedColumnLayerGridRepresentation*>(gsoapProxy2_2)->TruncationCellPatch->TruncationCellCount;
	}
	else {
		throw logic_error("Not implemented yet");
	}
...
void AbstractGridRepresentation::getTruncatedCellIndices(ULONG64* cellIndices) const
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		auto rep = static_cast<gsoap_eml2_2::resqml22__AbstractTruncatedColumnLayerGridRepresentation*>(gsoapProxy2_2);

		if (rep->TruncationCellPatch->ParentCellIndices->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerExternalArray) {
			auto dsPart = static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(rep->TruncationCellPatch->ParentCellIndices)->Values->ExternalFileProxy[0];
			getHdfProxyFromDataset(dsPart)->readArrayNdOfULongValues(dsPart->PathInExternalFile, cellIndices);
		}
		else if (rep->TruncationCellPatch->ParentCellIndices->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerConstantArray) {
			for (ULONG64 i = 0; i < static_cast<gsoap_eml2_2::eml22__IntegerConstantArray*>(rep->TruncationCellPatch->ParentCellIndices)->Count; ++i) {
				cellIndices[i] = static_cast<gsoap_eml2_2::eml22__IntegerConstantArray*>(rep->TruncationCellPatch->ParentCellIndices)->Value;
			}
		}
		else
			throw logic_error("Not yet implemented.");
...
void AbstractGridRepresentation::getTruncatedFaceIndicesOfTruncatedCells(ULONG64 * faceIndices) const
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (rep->TruncationCellPatch->TruncationFacesPerCell->Elements->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerExternalArray) {
			auto dsPart = static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(rep->TruncationCellPatch->TruncationFacesPerCell->Elements)->Values->ExternalFileProxy[0];
...
void AbstractGridRepresentation::getCumulativeTruncatedFaceCountPerTruncatedCell(ULONG64 * cumulativeFaceCountPerCell) const
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (rep->TruncationCellPatch->TruncationFacesPerCell->CumulativeLength->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerExternalArray) {
			auto dsPart = static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(rep->TruncationCellPatch->TruncationFacesPerCell->CumulativeLength)->Values->ExternalFileProxy[0];
			getHdfProxyFromDataset(dsPart)->readArrayNdOfULongValues(dsPart->PathInExternalFile, cumulativeFaceCountPerCell);
		}
		else if (rep->TruncationCellPatch->TruncationFacesPerCell->CumulativeLength->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerLatticeArray) {
			cumulativeFaceCountPerCell[0] = static_cast<gsoap_eml2_2::eml22__IntegerLatticeArray*>(rep->TruncationCellPatch->TruncationFacesPerCell->CumulativeLength)->StartValue;
			const LONG64 offsetValue = static_cast<gsoap_eml2_2::eml22__IntegerLatticeArray*>(rep->TruncationCellPatch->TruncationFacesPerCell->CumulativeLength)->Offset[0]->Value;
			const ULONG64 cellCount = getTruncatedCellCount();
			for (ULONG64 cumulativeFaceCountPerCellIndex = 1; cumulativeFaceCountPerCellIndex < cellCount; ++cumulativeFaceCountPerCellIndex) {
				cumulativeFaceCountPerCell[cumulativeFaceCountPerCellIndex] = cumulativeFaceCountPerCell[cumulativeFaceCountPerCellIndex - 1] + offsetValue;
			}
		}
		else if (rep->TruncationCellPatch->TruncationFacesPerCell->CumulativeLength->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerConstantArray) {
			if (getTruncatedCellCount() > 1)
				throw range_error("The cumulative length of faces count per cells cannot be constant if there is more than one cell in the grid");
			cumulativeFaceCountPerCell[0] = static_cast<gsoap_eml2_2::eml22__IntegerConstantArray*>(rep->TruncationCellPatch->TruncationFacesPerCell->CumulativeLength)->Value;
		}
	}
	else {
		throw logic_error("Not implemented yet");
...
void AbstractGridRepresentation::getNonTruncatedFaceIndicesOfTruncatedCells(ULONG64 * faceIndices) const
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (rep->TruncationCellPatch->LocalFacesPerCell->Elements->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerExternalArray) {
			auto dsPart = static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(rep->TruncationCellPatch->LocalFacesPerCell->Elements)->Values->ExternalFileProxy[0];
			getHdfProxyFromDataset(dsPart)->readArrayNdOfULongValues(dsPart->PathInExternalFile, faceIndices);
		}
		else
			throw logic_error("Not yet implemented");
...
void AbstractGridRepresentation::getCumulativeNonTruncatedFaceCountPerTruncatedCell(ULONG64 * cumulativeFaceCountPerCell) const
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (rep->TruncationCellPatch->LocalFacesPerCell->CumulativeLength->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerExternalArray) {
			auto dsPart = static_cast<gsoap_eml2_2::eml22__IntegerExternalArray*>(rep->TruncationCellPatch->LocalFacesPerCell->CumulativeLength)->Values->ExternalFileProxy[0];
			getHdfProxyFromDataset(dsPart)->readArrayNdOfULongValues(dsPart->PathInExternalFile, cumulativeFaceCountPerCell);
		}
		else if (rep->TruncationCellPatch->LocalFacesPerCell->CumulativeLength->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerLatticeArray) {
			cumulativeFaceCountPerCell[0] = static_cast<gsoap_eml2_2::eml22__IntegerLatticeArray*>(rep->TruncationCellPatch->LocalFacesPerCell->CumulativeLength)->StartValue;
			const LONG64 offsetValue = static_cast<gsoap_eml2_2::eml22__IntegerLatticeArray*>(rep->TruncationCellPatch->LocalFacesPerCell->CumulativeLength)->Offset[0]->Value;
			const ULONG64 cellCount = getTruncatedCellCount();
			for (ULONG64 cumulativeFaceCountPerCellIndex = 1; cumulativeFaceCountPerCellIndex < cellCount; ++cumulativeFaceCountPerCellIndex) {
				cumulativeFaceCountPerCell[cumulativeFaceCountPerCellIndex] = cumulativeFaceCountPerCell[cumulativeFaceCountPerCellIndex - 1] + offsetValue;
			}
		}
		else if (rep->TruncationCellPatch->LocalFacesPerCell->CumulativeLength->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__IntegerConstantArray) {
			if (getTruncatedCellCount() > 1)
				throw range_error("The cumulative length of faces count per cells cannot be constant if there is more than one cell in the grid");
			cumulativeFaceCountPerCell[0] = static_cast<gsoap_eml2_2::eml22__IntegerConstantArray*>(rep->TruncationCellPatch->LocalFacesPerCell->CumulativeLength)->Value;
		}
	}
	else {
		throw logic_error("Not implemented yet");
...
void AbstractGridRepresentation::getTruncatedFaceIsRightHanded(unsigned char* cellFaceIsRightHanded) const
{
	...
	if (gsoapProxy2_0_1 != nullptr) {
		...
		if (rep->TruncationCellPatch->TruncationCellFaceIsRightHanded->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__BooleanExternalArray) {
			auto dsPart = static_cast<gsoap_eml2_2::eml22__BooleanExternalArray*>(rep->TruncationCellPatch->TruncationCellFaceIsRightHanded)->Values->ExternalFileProxy[0];
			getHdfProxyFromDataset(dsPart)->readArrayNdOfUCharValues(dsPart->PathInExternalFile, cellFaceIsRightHanded);
		}
		else if (rep->TruncationCellPatch->TruncationCellFaceIsRightHanded->soap_type() == SOAP_TYPE_gsoap_eml2_2_eml22__BooleanConstantArray) {
			for (ULONG64 i = 0; i < static_cast<gsoap_eml2_2::eml22__BooleanConstantArray*>(rep->TruncationCellPatch->TruncationCellFaceIsRightHanded)->Count; ++i) {
				cellFaceIsRightHanded[i] = static_cast<gsoap_eml2_2::eml22__BooleanConstantArray*>(rep->TruncationCellPatch->TruncationCellFaceIsRightHanded)->Value;
			}
		}
		else
			throw logic_error("Not implemented yet.");
