...
{
	class DLL_IMPORT_OR_EXPORT Trajectory : public WITSML2_0_NS::AbstractObject
	{
	private:
		gsoap_eml2_1::witsml2__TrajectoryStation* getTrajectoryStation(const unsigned int & trajStationIndex) const;
	...
	public:
		...
		*/
		Trajectory(gsoap_eml2_1::witsml2__Trajectory* fromGsoap):AbstractObject(fromGsoap), resqmlWellboreTrajectoryRepresentation(nullptr) {}
		...
		*/
		...
		gsoap_eml2_1::eml21__LengthUom getMdUom(const unsigned int & trajStationIndex) const;
		std::string getMdDatum(const unsigned int & trajStationIndex) const;

		gsoap_eml2_1::witsml2__TrajStationType getTrajStationType(const unsigned int & trajStationIndex) const;
