...
namespace WITSML2_0_NS
{
	...
	protected:
		...
		std::vector<WITSML2_0_NS::Trajectory*> trajectorySet;
		std::vector<WITSML2_0_NS::Log*> logSet;
		std::vector<WITSML2_0_NS::WellboreMarkerSet*> wellboreMarkerSetSet;
		
		friend void WITSML2_0_NS::Trajectory::setWellbore(Wellbore* witsmlWellbore);
		friend void WITSML2_0_NS::Log::setWellbore(Wellbore* witsmlWellbore);
		friend void WITSML2_0_NS::WellboreMarkerSet::setWellbore(Wellbore* witsmlWellbore);
