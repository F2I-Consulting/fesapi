...
{
	class DLL_IMPORT_OR_EXPORT Log : public WITSML2_0_NS::AbstractObject
	{
	public:
		/**
		...
		*/
		Log(gsoap_eml2_1::witsml2__Log* fromGsoap) :AbstractObject(fromGsoap), resqmlWellboreFrameRepresentation(nullptr) {}
