...
namespace WITSML2_0_NS
{
	...
	public:
		 ...
		 */
		DLL_IMPORT_OR_EXPORT WellboreMarker(gsoap_resqml2_0_1::eml20__DataObjectReference* partialObject) : WellboreObject(partialObject) {}
		 ...
		 * @param 	  	mdDatum		  	A free string to unformally indicate the datum of the MD (i.e. where MD==0).
		 */
		WellboreMarker(Wellbore* witsmlWellbore,
			const std::string & guid,
			const std::string & title,
			double md, gsoap_eml2_1::eml21__LengthUom mdUom, const std::string & mdDatum);
		 ...
		 */
		WellboreMarker(gsoap_eml2_1::witsml20__WellboreMarker* fromGsoap) :WellboreObject(fromGsoap) {}
