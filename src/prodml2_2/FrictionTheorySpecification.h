...
namespace PRODML2_2_NS
{
	...
	public:
		 ...
		 */
		FrictionTheorySpecification(gsoap_eml2_3::prodml22__FrictionTheory* fromGsoap): CompositionalViscositySpecification(fromGsoap) {}
		...
		DLL_IMPORT_OR_EXPORT uint64_t getPrsvParameterCount() const noexcept {
			return static_cast<gsoap_eml2_3::prodml22__FrictionTheory*>(gsoapProxy)->PrsvParameter.size();
		}
		...
		DLL_IMPORT_OR_EXPORT double getPrsvParameterA1(uint64_t index) const {
			return static_cast<gsoap_eml2_3::prodml22__FrictionTheory*>(gsoapProxy)->PrsvParameter.at(index)->a1;
		}
		...
		DLL_IMPORT_OR_EXPORT double getPrsvParameterA2(uint64_t index) const {
			return static_cast<gsoap_eml2_3::prodml22__FrictionTheory*>(gsoapProxy)->PrsvParameter.at(index)->a2;
		}
		...
		DLL_IMPORT_OR_EXPORT double getPrsvParameterB1(uint64_t index) const {
			return static_cast<gsoap_eml2_3::prodml22__FrictionTheory*>(gsoapProxy)->PrsvParameter.at(index)->b1;
		}
		...
		DLL_IMPORT_OR_EXPORT double getPrsvParameterB2(uint64_t index) const {
			return static_cast<gsoap_eml2_3::prodml22__FrictionTheory*>(gsoapProxy)->PrsvParameter.at(index)->b2;
		}
		...
		DLL_IMPORT_OR_EXPORT double getPrsvParameterC2(uint64_t index) const {
			return static_cast<gsoap_eml2_3::prodml22__FrictionTheory*>(gsoapProxy)->PrsvParameter.at(index)->c2;
		}
		...
		DLL_IMPORT_OR_EXPORT std::string getPrsvParameterFluidComponentReference(uint64_t index) const {
			return static_cast<gsoap_eml2_3::prodml22__FrictionTheory*>(gsoapProxy)->PrsvParameter.at(index)->fluidComponentReference;
		}
