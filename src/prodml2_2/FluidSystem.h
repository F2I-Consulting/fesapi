...
#define GETTER_FLUID_COMPONENT_ATTRIBUTE(componentName, attributeName, attributeDatatype)\
	DLL_IMPORT_OR_EXPORT attributeDatatype get##componentName##attributeName() const {\
		if (static_cast<gsoap_eml2_3::prodml22__FluidSystem*>(gsoapProxy2_3)->componentName == nullptr) { throw std::logic_error("The component does not exist"); }\
		return static_cast<gsoap_eml2_3::prodml22__FluidSystem*>(gsoapProxy2_3)->componentName->attributeName;\
	}
...
#define GETTER_AND_SETTER_FLUID_COMPONENT_OPTIONAL_ATTRIBUTE(componentName, attributeName, attributeDatatype)\
	...
	DLL_IMPORT_OR_EXPORT bool has##componentName##attributeName() const {\
		return	static_cast<gsoap_eml2_3::prodml22__FluidSystem*>(gsoapProxy2_3)->componentName != nullptr &&\
				static_cast<gsoap_eml2_3::prodml22__FluidSystem*>(gsoapProxy2_3)->componentName->attributeName != nullptr;\
	}\
	DLL_IMPORT_OR_EXPORT attributeDatatype get##componentName##attributeName() const {\
...
#define GETTER_AND_SETTER_FLUID_COMPONENT_MEASURE_ATTRIBUTE(componentName, attributeName, uomDatatype)\
	...
	DLL_IMPORT_OR_EXPORT double get##componentName##attributeName##Value() const {\
		if (!has##componentName##attributeName()) { throw std::logic_error("This attribute in this component attribute does not exist"); }\
		return static_cast<gsoap_eml2_3::prodml22__FluidSystem*>(gsoapProxy2_3)->componentName->attributeName->__item;\
	}\
	DLL_IMPORT_OR_EXPORT uomDatatype get##componentName##attributeName##Uom() const {\
		if (!has##componentName##attributeName()) { throw std::logic_error("This attribute in this component attribute does not exist"); }\
		return static_cast<gsoap_eml2_3::prodml22__FluidSystem*>(gsoapProxy2_3)->componentName->attributeName->uom;\
	}
...
#define GETTER_AND_SETTER_FLUID_COMPONENT_COMMON_ATTRIBUTES(componentName)\
	...
	GETTER_AND_SETTER_FLUID_COMPONENT_MEASURE_ATTRIBUTE(componentName, MassFraction, gsoap_eml2_3::eml23__MassPerMassUom)\
	GETTER_AND_SETTER_FLUID_COMPONENT_MEASURE_ATTRIBUTE(componentName, MoleFraction, gsoap_eml2_3::eml23__AmountOfSubstancePerAmountOfSubstanceUom)
...
namespace PRODML2_2_NS
{
	...
	public:
		 ...
		 */
		FluidSystem(gsoap_eml2_3::prodml22__FluidSystem* fromGsoap):AbstractObject(fromGsoap)  {}

		/** Destructor does nothing since the memory is managed by the gsoap context. */
		~FluidSystem() = default;
		
		GETTER_SETTER_ATTRIBUTE(gsoap_eml2_3::prodml22__FluidSystem, gsoapProxy2_3, ReservoirFluidKind, gsoap_eml2_3::prodml22__ReservoirFluidKind)

		GETTER_SETTER_OPTIONAL_ATTRIBUTE(gsoap_eml2_3::prodml22__FluidSystem, gsoapProxy2_3, PhasesPresent, gsoap_eml2_3::prodml22__PhasePresent)
		GETTER_SETTER_OPTIONAL_ATTRIBUTE(gsoap_eml2_3::prodml22__FluidSystem, gsoapProxy2_3, ReservoirLifeCycleState, gsoap_eml2_3::prodml22__ReservoirLifeCycleState)
		GETTER_SETTER_OPTIONAL_ATTRIBUTE(gsoap_eml2_3::prodml22__FluidSystem, gsoapProxy2_3, Remark, std::string)
		 ...
		 */
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::eml23__VolumePerVolumeUom getSolutionGORUom() const;

		/**
		 * Sets the saturation pressure of this fluid system
		 */
		DLL_IMPORT_OR_EXPORT void setSaturationPressure(double value, gsoap_eml2_3::eml23__PressureUom pressureUom, gsoap_eml2_3::prodml22__SaturationPointKind saturationPointKind);
		 ...
		 */
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::eml23__PressureUom getSaturationPressureUom() const;
		 ...
		 */
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::prodml22__SaturationPointKind getSaturationPressurePointKind() const;
		...
		*/
		 ...
		 * @returns	The XML tag.
		 */
		DLL_IMPORT_OR_EXPORT static constexpr char const* XML_TAG = "FluidSystem";
