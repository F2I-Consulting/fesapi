...
namespace PRODML2_2_NS
{
	...
	public:
		...
		DLL_IMPORT_OR_EXPORT unsigned int getCoefficientCount() const {
			...
			size_t count = static_cast<gsoap_eml2_3::prodml22__AbstractPvtModel*>(gsoapProxy)->PvtModelParameterSet->Coefficient.size();
		 ...
		 */
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::prodml22__PvtModelParameterKind getCoefficientKind(unsigned int index) const;
