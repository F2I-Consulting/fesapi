...
{
	prodml22__PrsvParameter* param = soap_new_prodml22__PrsvParameter(gsoapProxy->soap);
	static_cast<gsoap_eml2_3::prodml22__FrictionTheory*>(gsoapProxy)->PrsvParameter.push_back(param);
	param->a1 = a1;
	param->a2 = a2;
	param->b1 = b1;
	param->b2 = b2;
