	...
	const std::string & title)
{
	...
	gsoapProxy2_3 = soap_new_prodml22__TimeSeriesData(repo->getGsoapContext());
...
void TimeSeriesData::pushBackKeywordValue(gsoap_eml2_3::prodml22__TimeSeriesKeyword keyword, const std::string & value)
{
	auto keyVal = soap_new_prodml22__KeywordValueStruct(getGsoapContext());
...
{
	auto dblVal = soap_new_prodml22__DoubleValue(getGsoapContext());
	dblVal->DoubleValue = soap_new_prodml22__TimeSeriesDoubleSample(getGsoapContext());
...
void TimeSeriesData::pushBackDoubleValue(double value, time_t timestamp, gsoap_eml2_3::prodml22__ValueStatus status)
{
	pushBackDoubleValue(value, timestamp);

	prodml22__TimeSeriesData* tsData = static_cast<prodml22__TimeSeriesData*>(gsoapProxy2_3);
	static_cast<prodml22__DoubleValue*>(tsData->DataValue[tsData->DataValue.size() - 1])->DoubleValue->status = soap_new_prodml22__ValueStatus(getGsoapContext());
	*static_cast<prodml22__DoubleValue*>(tsData->DataValue[tsData->DataValue.size() - 1])->DoubleValue->status = status;
}

void TimeSeriesData::pushBackStringValue(const std::string & value, time_t timestamp)
{
	auto strVal = soap_new_prodml22__StringValue(getGsoapContext());
	strVal->StringValue = soap_new_prodml22__TimeSeriesStringSample(getGsoapContext());
...
{
	return static_cast<prodml22__TimeSeriesData*>(gsoapProxy2_3)->Uom == nullptr
		? ""
		: *static_cast<prodml22__TimeSeriesData*>(gsoapProxy2_3)->Uom;
}

std::string TimeSeriesData::getMeasureClassAsString() const
{
	return static_cast<prodml22__TimeSeriesData*>(gsoapProxy2_3)->MeasureClass == nullptr
		? ""
...
{
	const size_t result = static_cast<prodml22__TimeSeriesData*>(gsoapProxy2_3)->DataValue.size();
...
bool TimeSeriesData::isDoubleValue(unsigned int index) const
{
	...
	return tsData->DataValue[index]->soap_type() == SOAP_TYPE_gsoap_eml2_3_prodml22__DoubleValue;
}
...
bool TimeSeriesData::isStringValue(unsigned int index) const
{
	...
	return tsData->DataValue[index]->soap_type() == SOAP_TYPE_gsoap_eml2_3_prodml22__StringValue;
}
...
double TimeSeriesData::getDoubleValue(unsigned int index) const
{
	...
	prodml22__TimeSeriesData* tsData = static_cast<prodml22__TimeSeriesData*>(gsoapProxy2_3);
	return static_cast<prodml22__DoubleValue*>(tsData->DataValue[index])->DoubleValue->__item;
}
...
std::string TimeSeriesData::getStringValue(unsigned int index) const
{
	...
	prodml22__TimeSeriesData* tsData = static_cast<prodml22__TimeSeriesData*>(gsoapProxy2_3);
	return static_cast<prodml22__StringValue*>(tsData->DataValue[index])->StringValue->__item;
}
...
time_t TimeSeriesData::getValueTimestamp(unsigned int index) const
{
	...
	tm* result = nullptr;
	if (isDoubleValue(index)) {
		result = static_cast<prodml22__DoubleValue*>(tsData->DataValue[index])->DoubleValue->dTim;
	}
	else if (isStringValue(index)) {
		result = static_cast<prodml22__StringValue*>(tsData->DataValue[index])->StringValue->dTim;
	}
	else {
...
bool TimeSeriesData::hasValueStatus(unsigned int index) const
{
	...
	prodml22__TimeSeriesData* tsData = static_cast<prodml22__TimeSeriesData*>(gsoapProxy2_3);
	return static_cast<prodml22__DoubleValue*>(tsData->DataValue[index])->DoubleValue->status != nullptr;
}

gsoap_eml2_3::prodml22__ValueStatus TimeSeriesData::getValueStatus(unsigned int index) const
{
	...
	prodml22__TimeSeriesData* tsData = static_cast<prodml22__TimeSeriesData*>(gsoapProxy2_3);
	return *static_cast<prodml22__DoubleValue*>(tsData->DataValue[index])->DoubleValue->status;
}

unsigned int TimeSeriesData::getKeywordCount() const
{
	const size_t result = static_cast<prodml22__TimeSeriesData*>(gsoapProxy2_3)->Key.size();
	if (result > (std::numeric_limits<unsigned int>::max)()) {
...
gsoap_eml2_3::prodml22__TimeSeriesKeyword TimeSeriesData::getKeyword(unsigned int index) const
{
	prodml22__TimeSeriesData* tsData = static_cast<prodml22__TimeSeriesData*>(gsoapProxy2_3);
