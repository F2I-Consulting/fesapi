...
gsoap_eml2_3::prodml22__ValueStatus TimeSeriesData::getValueStatus(uint64_t index) const
{
...
gsoap_eml2_3::prodml22__TimeSeriesKeyword TimeSeriesData::getKeyword(uint64_t index) const
{
	return static_cast<prodml22__TimeSeriesData*>(gsoapProxy2_3)->Key.at(index)->keyword;
}
