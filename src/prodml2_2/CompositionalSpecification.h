...
#define GETTER_AND_SETTER_FLUID_COMPONENT_PROPERTY_OPTIONAL_ATTRIBUTE(vectorName, attributeName, attributeDatatype)\
	...
	DLL_IMPORT_OR_EXPORT bool has##vectorName##attributeName(unsigned int index) const {\
		return	static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->ComponentPropertySet != nullptr &&\
				static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->ComponentPropertySet->vectorName.size() > index &&\
				static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->ComponentPropertySet->vectorName[index]->attributeName != nullptr;\
	}\
	DLL_IMPORT_OR_EXPORT attributeDatatype get##vectorName##attributeName(unsigned int index) const {\
		...
		return *static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->ComponentPropertySet->vectorName[index]->attributeName;\
	}
...
#define GETTER_AND_SETTER_FLUID_COMPONENT_PROPERTY_MEASURE_ATTRIBUTE(vectorName, attributeName, uomDatatype)\
	...
	DLL_IMPORT_OR_EXPORT double get##vectorName##attributeName##Value(unsigned int index) const {\
		if (!has##vectorName##attributeName(index)) { throw std::out_of_range("The index is out of range"); }\
		return static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->ComponentPropertySet->vectorName[index]->attributeName->__item;\
	}\
	DLL_IMPORT_OR_EXPORT uomDatatype get##vectorName##attributeName##Uom(unsigned int index) const {\
		if (!has##vectorName##attributeName(index)) { throw std::out_of_range("The index is out of range"); }\
		return static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->ComponentPropertySet->vectorName[index]->attributeName->uom;\
	}
...
namespace PRODML2_2_NS
{
	...
	public:
		 ...
		 */
		CompositionalSpecification(gsoap_eml2_3::prodml22__AbstractCompositionalModel* fromGsoap):PvtSpecification(fromGsoap)  {}
		 ...
		 */
		DLL_IMPORT_OR_EXPORT bool hasMixingRule() const { return static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->MixingRule != nullptr; }
		 ...
		 */
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::prodml22__MixingRule getMixingRule() const {
			if (!hasMixingRule()) { throw std::invalid_argument("There is no mixing rule to get"); }
			return *static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->MixingRule;
		}
		 ...
		 */
		DLL_IMPORT_OR_EXPORT void setMixingRule(gsoap_eml2_3::prodml22__MixingRule mixingRule);
		...
		DLL_IMPORT_OR_EXPORT unsigned int getBinaryInteractionCoefficientCount() const {
			...
			size_t count = static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->BinaryInteractionCoefficientSet->BinaryInteractionCoefficient.size();
		...
		DLL_IMPORT_OR_EXPORT std::string getBinaryInteractionCoefficientFluidComponent1Reference(unsigned int index) const
		{
			...
			return static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->BinaryInteractionCoefficientSet->BinaryInteractionCoefficient[index]->fluidComponent1Reference;
		}
		...
		DLL_IMPORT_OR_EXPORT bool hasBinaryInteractionCoefficientFluidComponent2Reference(unsigned int index) const
		{
			...
			return static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->BinaryInteractionCoefficientSet->BinaryInteractionCoefficient[index]->fluidComponent2Reference != nullptr;
		}
		...
		DLL_IMPORT_OR_EXPORT std::string getBinaryInteractionCoefficientFluidComponent2Reference(unsigned int index) const
		{
			...
			return *static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->BinaryInteractionCoefficientSet->BinaryInteractionCoefficient[index]->fluidComponent2Reference;
		}
		...
		DLL_IMPORT_OR_EXPORT unsigned int getFluidComponentPropertyCount() const {
			...
			size_t count = static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->ComponentPropertySet->FluidComponentProperty.size();
			if (count > (std::numeric_limits<unsigned int>::max)()) {
		...
		DLL_IMPORT_OR_EXPORT std::string getFluidComponentPropertyFluidComponentReference(unsigned int index) const{
			if (static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->ComponentPropertySet == nullptr ||
				static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->ComponentPropertySet->FluidComponentProperty.size() <= index) {
				throw std::out_of_range("The FluidComponentProperty at this index does not exist");
			}

			return static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->ComponentPropertySet->FluidComponentProperty[index]->fluidComponentReference;
		}
