...
namespace PRODML2_2_NS
{
	...
	public:
		...
		DLL_IMPORT_OR_EXPORT uint64_t getBinaryInteractionCoefficientCount() const noexcept {
			return static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->BinaryInteractionCoefficientSet == nullptr
				? 0
				: static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->BinaryInteractionCoefficientSet->BinaryInteractionCoefficient.size();
		}
		...
		DLL_IMPORT_OR_EXPORT std::string getBinaryInteractionCoefficientFluidComponent1Reference(uint64_t index) const
		{
			...
			return static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->BinaryInteractionCoefficientSet->BinaryInteractionCoefficient.at(index)->fluidComponent1Reference;
		}
		...
		DLL_IMPORT_OR_EXPORT uint64_t getFluidComponentPropertyCount() const noexcept {
			return static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->ComponentPropertySet == nullptr
				? 0
				: static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->ComponentPropertySet->FluidComponentProperty.size();
		}
		...
		DLL_IMPORT_OR_EXPORT std::string getFluidComponentPropertyFluidComponentReference(uint64_t index) const{
			...
			return static_cast<gsoap_eml2_3::prodml22__AbstractCompositionalModel*>(gsoapProxy)->ComponentPropertySet->FluidComponentProperty.at(index)->fluidComponentReference;
		}
