...
#define GETTER_FLUID_CATALOG_COMPONENT_ATTRIBUTE(vectorName, attributeName, attributeDatatype)\
	DLL_IMPORT_OR_EXPORT attributeDatatype get##vectorName##attributeName(unsigned int index) const {\
		if (static_cast<gsoap_eml2_3::prodml22__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog == nullptr ||\
			static_cast<gsoap_eml2_3::prodml22__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->vectorName.size() <= index) { throw std::out_of_range("The index is out of range"); }\
		return static_cast<gsoap_eml2_3::prodml22__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->vectorName[index]->attributeName;\
	}
...
#define GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_OPTIONAL_ATTRIBUTE(vectorName, attributeName, attributeDatatype)\
	...
	DLL_IMPORT_OR_EXPORT bool has##vectorName##attributeName(unsigned int index) const {\
		return	static_cast<gsoap_eml2_3::prodml22__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog != nullptr &&\
				static_cast<gsoap_eml2_3::prodml22__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->vectorName.size() > index &&\
				static_cast<gsoap_eml2_3::prodml22__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->vectorName[index]->attributeName != nullptr;\
	}\
	DLL_IMPORT_OR_EXPORT attributeDatatype get##vectorName##attributeName(unsigned int index) const {\
...
#define GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(vectorName, attributeName, uomDatatype)\
	...
	DLL_IMPORT_OR_EXPORT double get##vectorName##attributeName##Value(unsigned int index) const {\
		if (!has##vectorName##attributeName(index)) { throw std::out_of_range("The index is out of range"); }\
		return static_cast<gsoap_eml2_3::prodml22__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->vectorName[index]->attributeName->__item;\
	}\
	DLL_IMPORT_OR_EXPORT uomDatatype get##vectorName##attributeName##Uom(unsigned int index) const {\
		if (!has##vectorName##attributeName(index)) { throw std::out_of_range("The index is out of range"); }\
		return static_cast<gsoap_eml2_3::prodml22__FluidCharacterization*>(gsoapProxy2_3)->FluidComponentCatalog->vectorName[index]->attributeName->uom;\
	}
...
#define GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_COMMON_ATTRIBUTES(vectorName)\
	...
	GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(vectorName, MassFraction, gsoap_eml2_3::eml23__MassPerMassUom)\
	GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(vectorName, MoleFraction, gsoap_eml2_3::eml23__AmountOfSubstancePerAmountOfSubstanceUom)
...
namespace PRODML2_2_NS
{
	...
	public:
		 ...
		 */
		FluidCharacterization(gsoap_eml2_3::prodml22__FluidCharacterization* fromGsoap):AbstractObject(fromGsoap)  {}
		...
		GETTER_SETTER_OPTIONAL_ATTRIBUTE(gsoap_eml2_3::prodml22__FluidCharacterization, gsoapProxy2_3, Kind, std::string)
		GETTER_SETTER_OPTIONAL_ATTRIBUTE(gsoap_eml2_3::prodml22__FluidCharacterization, gsoapProxy2_3, IntendedUsage, std::string)
		GETTER_SETTER_OPTIONAL_ATTRIBUTE(gsoap_eml2_3::prodml22__FluidCharacterization, gsoapProxy2_3, Remark, std::string)
		 ...
		 */
		DLL_IMPORT_OR_EXPORT void setStandardConditions(double temperatureValue, gsoap_eml2_3::eml23__ThermodynamicTemperatureUom temperatureUom,
		 ...
		 */
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::eml23__ThermodynamicTemperatureUom getStandardTemperatureUom() const;
		 ...
		 */
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::eml23__PressureUom getStandardPressureUom() const;
		...
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(FormationWater, Salinity, gsoap_eml2_3::eml23__MassPerMassUom)
		 ...
		 */
		DLL_IMPORT_OR_EXPORT void pushBackPureFluidComponent(const std::string & uid, gsoap_eml2_3::prodml22__PureComponentKind kind, bool hydrocarbonFlag);
		...
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(PureFluidComponent, MolecularWeight, gsoap_eml2_3::eml23__MolecularWeightUom)
		 ...
		 * @param 	kind	The kind.
		 */
		DLL_IMPORT_OR_EXPORT void pushBackPlusFluidComponent(const std::string & uid, gsoap_eml2_3::prodml22__PlusComponentKind kind);
		...
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(StockTankOil, APIGravity, gsoap_eml2_3::eml23__APIGravityUom)
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(StockTankOil, MolecularWeight, gsoap_eml2_3::eml23__MolecularWeightUom)
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(StockTankOil, GrossEnergyContentPerUnitMass, gsoap_eml2_3::eml23__EnergyPerMassUom)
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(StockTankOil, NetEnergyContentPerUnitMass, gsoap_eml2_3::eml23__EnergyPerMassUom)
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(StockTankOil, GrossEnergyContentPerUnitVolume, gsoap_eml2_3::eml23__EnergyPerVolumeUom)
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(StockTankOil, NetEnergyContentPerUnitVolume, gsoap_eml2_3::eml23__EnergyPerVolumeUom)
		...
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(NaturalGas, MolecularWeight, gsoap_eml2_3::eml23__MolecularWeightUom)
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(NaturalGas, GrossEnergyContentPerUnitMass, gsoap_eml2_3::eml23__EnergyPerMassUom)
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(NaturalGas, NetEnergyContentPerUnitMass, gsoap_eml2_3::eml23__EnergyPerMassUom)
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(NaturalGas, GrossEnergyContentPerUnitVolume, gsoap_eml2_3::eml23__EnergyPerVolumeUom)
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(NaturalGas, NetEnergyContentPerUnitVolume, gsoap_eml2_3::eml23__EnergyPerVolumeUom)
		 ...
		 * @param 	kind	The kind.
		 */
		DLL_IMPORT_OR_EXPORT void pushBackPseudoFluidComponent(const std::string & uid, gsoap_eml2_3::prodml22__PseudoComponentKind kind);
		...
		GETTER_AND_SETTER_FLUID_CATALOG_COMPONENT_MEASURE_ATTRIBUTE(PseudoFluidComponent, AvgMolecularWeight, gsoap_eml2_3::eml23__MolecularWeightUom)
		...
		GETTER_SETTER_OPTIONAL_ATTRIBUTE_IN_VECTOR(gsoap_eml2_3::prodml22__FluidCharacterization, gsoapProxy2_3, Model, Name, std::string)
		GETTER_SETTER_OPTIONAL_ATTRIBUTE_IN_VECTOR(gsoap_eml2_3::prodml22__FluidCharacterization, gsoapProxy2_3, Model, Remark, std::string)
		GETTER_SETTER_MEASURE_OPTIONAL_ATTRIBUTE_IN_VECTOR(gsoap_eml2_3::prodml22__FluidCharacterization, gsoapProxy2_3, Model, ReferenceTemperature, gsoap_eml2_3::eml23__ThermodynamicTemperatureUom)
		GETTER_SETTER_MEASURE_OPTIONAL_ATTRIBUTE_IN_VECTOR(gsoap_eml2_3::prodml22__FluidCharacterization, gsoapProxy2_3, Model, ReferenceStockTankTemperature, gsoap_eml2_3::eml23__ThermodynamicTemperatureUom)
		...
		*/
		DLL_IMPORT_OR_EXPORT void pushBackTableFormatColumn(unsigned int tableFormatIndex, gsoap_eml2_3::eml23__UnitOfMeasure uom, gsoap_eml2_3::prodml22__OutputFluidProperty fluidProperty);
		...
		*/
		DLL_IMPORT_OR_EXPORT void pushBackParameter(unsigned int modelIndex, double value, gsoap_eml2_3::eml23__UnitOfMeasure uom, gsoap_eml2_3::prodml22__OutputFluidProperty fluidProperty);
		...
		*/
		DLL_IMPORT_OR_EXPORT void pushBackParameter(unsigned int modelIndex, double value, gsoap_eml2_3::eml23__UnitOfMeasure uom, gsoap_eml2_3::prodml22__OutputFluidProperty fluidProperty, gsoap_eml2_3::prodml22__ThermodynamicPhase phase);
		 ...
		 * @returns	The XML tag.
		 */
		DLL_IMPORT_OR_EXPORT static constexpr char const* XML_TAG = "FluidCharacterization";
		...
		*/
		DLL_IMPORT_OR_EXPORT static constexpr char const* XML_NS = "prodml22";
