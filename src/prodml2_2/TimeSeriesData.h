...
namespace PRODML2_2_NS
{
	...
	public:
		...
		*/
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::prodml22__ValueStatus getValueStatus(uint64_t index) const;
		...
		*/
		DLL_IMPORT_OR_EXPORT  gsoap_eml2_3::prodml22__TimeSeriesKeyword getKeyword(uint64_t index) const;
