...
namespace PRODML2_2_NS
{
	...
	public:
		 ...
		 */
		TimeSeriesData(gsoap_eml2_3::prodml22__TimeSeriesData* fromGsoap):AbstractObject(fromGsoap)  {}
		...
		*/
		DLL_IMPORT_OR_EXPORT void pushBackKeywordValue(gsoap_eml2_3::prodml22__TimeSeriesKeyword keyword, const std::string & value);
		...
		*/
		DLL_IMPORT_OR_EXPORT void setMeasureClass(gsoap_eml2_3::eml23__MeasureClass measureClass);
		...
		*/
		DLL_IMPORT_OR_EXPORT void pushBackDoubleValue(double value, time_t timestamp, gsoap_eml2_3::prodml22__ValueStatus status);
		...
		*/
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::prodml22__ValueStatus getValueStatus(unsigned int index) const;
		...
		*/
		DLL_IMPORT_OR_EXPORT gsoap_eml2_3::prodml22__TimeSeriesKeyword getKeyword(unsigned int index) const;
		...
		*/
		 ...
		 * @returns	The XML tag.
		 */
		DLL_IMPORT_OR_EXPORT static constexpr char const* XML_TAG = "TimeSeriesData";
