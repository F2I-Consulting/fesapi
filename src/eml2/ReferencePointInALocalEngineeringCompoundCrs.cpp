...
double ReferencePointInALocalEngineeringCompoundCrs::getXInGlobalCrs() const
{
...
double ReferencePointInALocalEngineeringCompoundCrs::getYInGlobalCrs() const
{
	double result[] = { getX(), getY(), .0 };
	if (result[0] != result[0])
		return result[0];
...
double ReferencePointInALocalEngineeringCompoundCrs::getZInGlobalCrs() const
{
