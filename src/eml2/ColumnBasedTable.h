...
namespace EML2_NS
{
	...
	public:
		 ...
		 */
		DLL_IMPORT_OR_EXPORT virtual COMMON_NS::AbstractObject::numericalDatatypeEnum getDatatype(uint64_t columnIndex) const = 0;
		 ...
		 */
		DLL_IMPORT_OR_EXPORT virtual void setDoubleValues(uint64_t columnIndex, double const* values, uint64_t valueCount, EML2_NS::AbstractHdfProxy * proxy = nullptr) = 0;
		 ...
		 * @param proxy			The hdf proxy which indicates the support where the values will be stored.
		 */
		DLL_IMPORT_OR_EXPORT virtual void setInt64Values(uint64_t columnIndex, int64_t const* values, uint64_t valueCount, EML2_NS::AbstractHdfProxy* proxy = nullptr) = 0;
