...
namespace EML2_3_NS
{
	...
	public:
		 ...
		 */
		DLL_IMPORT_OR_EXPORT void setDoubleValues(uint64_t columnIndex, double const* values, uint64_t valueCount, EML2_NS::AbstractHdfProxy* proxy = nullptr) final;
		 ...
		 * @param proxy			The hdf proxy which indicates the support where the values will be stored.
		 */
		DLL_IMPORT_OR_EXPORT void setInt64Values(uint64_t columnIndex, int64_t const* values, uint64_t valueCount, EML2_NS::AbstractHdfProxy* proxy = nullptr) final;
