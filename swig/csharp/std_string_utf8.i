 ...
 * std_string_utf8.i
 *
 * A copy of lib/csharp/std_string.i.
 * The only differences are at line 26 and 65, where a utf8 custom marshaler is registered to map the UTF-16 encoded C# strings into UTF-8 encoded C++ std::strings.  
 *
...
%typemap(imtype,
         inattributes="[global::System.Runtime.InteropServices.MarshalAs(global::System.Runtime.InteropServices.UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(f2i.energisticsStandardsApi.UTF8Marshaler))]",
		 outattributes="[return: global::System.Runtime.InteropServices.MarshalAs(global::System.Runtime.InteropServices.UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(f2i.energisticsStandardsApi.UTF8Marshaler))]") string "string"
