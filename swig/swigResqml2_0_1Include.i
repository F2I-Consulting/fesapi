...
namespace gsoap_resqml2_0_1
{
	...
	enum resqml20__ResqmlPropertyKind {
		...
		resqml20__ResqmlPropertyKind__force_x0020per_x0020volume = (int)'A',
		resqml20__ResqmlPropertyKind__formation_x0020volume_x0020factor = (int)'B',
		resqml20__ResqmlPropertyKind__frequency = (int)'C',
		resqml20__ResqmlPropertyKind__frequency_x0020interval = (int)'D',
		resqml20__ResqmlPropertyKind__gamma_x0020ray_x0020API_x0020unit = (int)'E',
		resqml20__ResqmlPropertyKind__heat_x0020capacity = (int)'F',
		resqml20__ResqmlPropertyKind__heat_x0020flow_x0020rate = (int)'G',
		resqml20__ResqmlPropertyKind__heat_x0020transfer_x0020coefficient = (int)'H',
		resqml20__ResqmlPropertyKind__illuminance = (int)'I',
		resqml20__ResqmlPropertyKind__index = (int)'J',
		resqml20__ResqmlPropertyKind__irradiance = (int)'K',
		resqml20__ResqmlPropertyKind__isothermal_x0020compressibility = (int)'L',
		resqml20__ResqmlPropertyKind__kinematic_x0020viscosity = (int)'M',
		resqml20__ResqmlPropertyKind__Lambda_x0020Rho = (int)'N',
		resqml20__ResqmlPropertyKind__Lame_x0020constant = (int)'O',
		resqml20__ResqmlPropertyKind__length = (int)'P',
		resqml20__ResqmlPropertyKind__length_x0020per_x0020length = (int)'Q',
		resqml20__ResqmlPropertyKind__length_x0020per_x0020temperature = (int)'R',
		resqml20__ResqmlPropertyKind__length_x0020per_x0020volume = (int)'S',
		resqml20__ResqmlPropertyKind__level_x0020of_x0020power_x0020intensity = (int)'T',
		resqml20__ResqmlPropertyKind__light_x0020exposure = (int)'U',
		resqml20__ResqmlPropertyKind__linear_x0020thermal_x0020expansion = (int)'V',
		resqml20__ResqmlPropertyKind__luminance = (int)'W',
		resqml20__ResqmlPropertyKind__luminous_x0020efficacy = (int)'X',
		resqml20__ResqmlPropertyKind__luminous_x0020flux = (int)'Y',
		resqml20__ResqmlPropertyKind__luminous_x0020intensity = (int)'Z',
		...
		resqml20__ResqmlPropertyKind__mass = (int)'a',
		resqml20__ResqmlPropertyKind__mass_x0020attenuation_x0020coefficient = (int)'b',
		resqml20__ResqmlPropertyKind__mass_x0020concentration = (int)'c',
		resqml20__ResqmlPropertyKind__mass_x0020flow_x0020rate = (int)'d',
		resqml20__ResqmlPropertyKind__mass_x0020length = (int)'e',
		resqml20__ResqmlPropertyKind__mass_x0020per_x0020energy = (int)'f',
		resqml20__ResqmlPropertyKind__mass_x0020per_x0020length = (int)'g',
		resqml20__ResqmlPropertyKind__mass_x0020per_x0020time_x0020per_x0020area = (int)'h',
		resqml20__ResqmlPropertyKind__mass_x0020per_x0020time_x0020per_x0020length = (int)'i',
		resqml20__ResqmlPropertyKind__mass_x0020per_x0020volume_x0020per_x0020length = (int)'j',
		resqml20__ResqmlPropertyKind__mobility = (int)'k',
		resqml20__ResqmlPropertyKind__modulus_x0020of_x0020compression = (int)'l',
		resqml20__ResqmlPropertyKind__molar_x0020concentration = (int)'m',
		resqml20__ResqmlPropertyKind__molar_x0020heat_x0020capacity = (int)'n',
		resqml20__ResqmlPropertyKind__molar_x0020volume = (int)'o',
		resqml20__ResqmlPropertyKind__mole_x0020per_x0020area = (int)'p',
		resqml20__ResqmlPropertyKind__mole_x0020per_x0020time = (int)'q',
		resqml20__ResqmlPropertyKind__mole_x0020per_x0020time_x0020per_x0020area = (int)'r',
		resqml20__ResqmlPropertyKind__moment_x0020of_x0020force = (int)'s',
		resqml20__ResqmlPropertyKind__moment_x0020of_x0020inertia = (int)'t',
		resqml20__ResqmlPropertyKind__moment_x0020of_x0020section = (int)'u',
		resqml20__ResqmlPropertyKind__momentum = (int)'v',
		resqml20__ResqmlPropertyKind__Mu_x0020Rho = (int)'w',
		resqml20__ResqmlPropertyKind__net_x0020to_x0020gross_x0020ratio = (int)'x',
		resqml20__ResqmlPropertyKind__neutron_x0020API_x0020unit = (int)'y',
		resqml20__ResqmlPropertyKind__nonDarcy_x0020flow_x0020coefficient = (int)'z',
