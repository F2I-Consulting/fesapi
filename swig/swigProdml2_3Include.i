...
-----------------------------------------------------------------------*/
%{
#include "../src/prodml2_3/FluidSystem.h"
#include "../src/prodml2_3/FluidCharacterization.h"
#include "../src/prodml2_3/TimeSeriesData.h"
%}

namespace std {
	%template(FluidSystemVector) vector<PRODML2_3_NS::FluidSystem*>;
	%template(FluidCharacterizationVector) vector<PRODML2_3_NS::FluidCharacterization*>;
	%template(TimeSeriesDataVector) vector<PRODML2_3_NS::TimeSeriesData*>;
}

#if defined(SWIGJAVA) || defined(SWIGCSHARP)
	%nspace PRODML2_3_NS::FluidSystem;
	%nspace PRODML2_3_NS::FluidCharacterization;
	%nspace PRODML2_3_NS::TimeSeriesData;
#endif
...
enum class prodml23__ThermodynamicPhase {
	aqueous = 0,
	oleic = 1,
	vapor = 2,
...
enum class prodml23__ReservoirFluidKind {
	black_x0020oil = 0,
...
enum class prodml23__PureComponentKind {
...
enum class prodml23__PlusComponentKind {
	c10_x002b = 0,
	c11_x002b = 1,
	c12_x002b = 2,
	c20_x002b = 3,
...
enum class prodml23__PseudoComponentKind {
	c10 = 0,
	c11 = 1,
	c12 = 2,
	c13 = 3,
...
enum class prodml23__OutputFluidProperty {
	Compressibility = 0,
	Density = 1,
...
enum class prodml23__TimeSeriesKeyword {
...
enum class prodml23__ValueStatus {
...
namespace PRODML2_3_NS
{
	...
	{
	public:
		gsoap_eml2_3::prodml23__ReservoirFluidKind getReservoirFluidKind() const;
	};
	...
	public:
		...
		GETTER_SETTER_OPTIONAL_ATTRIBUTE_IN_VECTOR(gsoap_eml2_3::prodml23__FluidCharacterization, gsoapProxy2_2, Model, Name, std::string)
		GETTER_SETTER_OPTIONAL_ATTRIBUTE_IN_VECTOR(gsoap_eml2_3::prodml23__FluidCharacterization, gsoapProxy2_2, Model, Remark, std::string)
		GETTER_SETTER_MEASURE_OPTIONAL_ATTRIBUTE_IN_VECTOR(gsoap_eml2_3::prodml23__FluidCharacterization, gsoapProxy2_2, Model, ReferenceTemperature, gsoap_eml2_3::eml23__ThermodynamicTemperatureUom)
		GETTER_SETTER_MEASURE_OPTIONAL_ATTRIBUTE_IN_VECTOR(gsoap_eml2_3::prodml23__FluidCharacterization, gsoapProxy2_2, Model, ReferenceStockTankTemperature, gsoap_eml2_3::eml23__ThermodynamicTemperatureUom)
