...
namespace gsoap_eml2_2
{
	...
	enum eml22__ThermodynamicTemperatureUom {
		eml22__ThermodynamicTemperatureUom__K = (int)'K',
		eml22__ThermodynamicTemperatureUom__degC = (int)'L',
		eml22__ThermodynamicTemperatureUom__degF = (int)'M',
		eml22__ThermodynamicTemperatureUom__degR = (int)'N'
	};
	...
	enum eml22__MeasureClass {
		...
		eml22__MeasureClass__heat_x0020transfer_x0020coefficient = (int)'A',
		eml22__MeasureClass__illuminance = (int)'B',
		eml22__MeasureClass__inductance = (int)'C',
		eml22__MeasureClass__isothermal_x0020compressibility = (int)'D',
		eml22__MeasureClass__kinematic_x0020viscosity = (int)'E',
		eml22__MeasureClass__length = (int)'F',
		eml22__MeasureClass__length_x0020per_x0020length = (int)'G',
		eml22__MeasureClass__length_x0020per_x0020mass = (int)'H',
		eml22__MeasureClass__length_x0020per_x0020pressure = (int)'I',
		eml22__MeasureClass__length_x0020per_x0020temperature = (int)'J',
		eml22__MeasureClass__length_x0020per_x0020time = (int)'K',
		eml22__MeasureClass__length_x0020per_x0020volume = (int)'L',
		eml22__MeasureClass__light_x0020exposure = (int)'M',
		eml22__MeasureClass__linear_x0020acceleration = (int)'N',
		eml22__MeasureClass__linear_x0020thermal_x0020expansion = (int)'O',
		eml22__MeasureClass__logarithmic_x0020power_x0020ratio = (int)'P',
		eml22__MeasureClass__logarithmic_x0020power_x0020ratio_x0020per_x0020length = (int)'Q',
		eml22__MeasureClass__luminance = (int)'R',
		eml22__MeasureClass__luminous_x0020efficacy = (int)'S',
		eml22__MeasureClass__luminous_x0020flux = (int)'T',
		eml22__MeasureClass__luminous_x0020intensity = (int)'U',
		eml22__MeasureClass__magnetic_x0020dipole_x0020moment = (int)'V',
		eml22__MeasureClass__magnetic_x0020field_x0020strength = (int)'W',
		eml22__MeasureClass__magnetic_x0020flux = (int)'X',
		eml22__MeasureClass__magnetic_x0020flux_x0020density = (int)'Y',
		eml22__MeasureClass__magnetic_x0020flux_x0020density_x0020per_x0020length = (int)'Z',
		...
		eml22__MeasureClass__mass_x0020per_x0020length = (int)'a',
		eml22__MeasureClass__mass_x0020per_x0020mass = (int)'b',
		eml22__MeasureClass__mass_x0020per_x0020time = (int)'c',
		eml22__MeasureClass__mass_x0020per_x0020time_x0020per_x0020area = (int)'d',
		eml22__MeasureClass__mass_x0020per_x0020time_x0020per_x0020length = (int)'e',
		eml22__MeasureClass__mass_x0020per_x0020volume = (int)'f',
		eml22__MeasureClass__mass_x0020per_x0020volume_x0020per_x0020length = (int)'g',
		eml22__MeasureClass__mass_x0020per_x0020volume_x0020per_x0020pressure = (int)'h',
		eml22__MeasureClass__mass_x0020per_x0020volume_x0020per_x0020temperature = (int)'i',
		eml22__MeasureClass__mobility = (int)'j',
		eml22__MeasureClass__molar_x0020energy = (int)'k',
		eml22__MeasureClass__molar_x0020heat_x0020capacity = (int)'l',
		eml22__MeasureClass__molar_x0020volume = (int)'m',
		eml22__MeasureClass__molecular_x0020weight = (int)'n',
		eml22__MeasureClass__moment_x0020of_x0020force = (int)'o',
		eml22__MeasureClass__moment_x0020of_x0020inertia = (int)'p',
		eml22__MeasureClass__momentum = (int)'q',
		eml22__MeasureClass__normalized_x0020power = (int)'r',
		eml22__MeasureClass__permeability_x0020length = (int)'s',
		eml22__MeasureClass__permeability_x0020rock = (int)'t',
		eml22__MeasureClass__permittivity = (int)'u',
		eml22__MeasureClass__plane_x0020angle = (int)'v',
		eml22__MeasureClass__potential_x0020difference_x0020per_x0020power_x0020drop = (int)'w',
		eml22__MeasureClass__power = (int)'x',
		eml22__MeasureClass__power_x0020per_x0020area = (int)'y',
		eml22__MeasureClass__power_x0020per_x0020power = (int)'z',
