...
${COMMENT_START}
	private static void serializeGraphicalInformationSet(DataObjectRepository repo, AbstractHdfProxy hdfProxy)
	{
		...
		HorizonInterpretation contColMapHrzInterp = repo.createBoundaryFeatureInterpretation(contColMapHrz, "34b69c81-6cfa-4531-be5b-f6bd9b74802f", "Horizon interpretation for continuous color map");
