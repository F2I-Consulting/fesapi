...
if(UUID_FOUND)
  ...
  if(NOT TARGET UUID::UUID)
      ...
      if(UUID_LIBRARY_RELEASE)
  			...
  			set_target_properties(UUID::UUID APPEND PROPERTY IMPORTED_LOCATION_RELEASE "${UUID_LIBRARY_RELEASE}")
  		endif()

  		if(UUID_LIBRARY_DEBUG)
  			set_property(TARGET UUID::UUID APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
  			set_target_properties(UUID::UUID APPEND PROPERTY IMPORTED_LOCATION_DEBUG "${UUID_LIBRARY_DEBUG}")
  		endif()
